...
for i in ieee iso iec bsi gb mpfa bipm w3c 3gpp csa cc ietf iho itu m3aawg nist ribose ogc un cen ecma cie iana omg oasis jis etsi
do
...
for i in biblio biblio-compile biblio-standoc basicdoc reqt relaton-ieee relaton-iso relaton-iec relaton-bsi relaton-gb relaton-mpfa relaton-bipm relaton-w3c relaton-3gpp relaton-csa relaton-cc relaton-ietf relaton-iho relaton-itu relaton-m3aawg relaton-nist relaton-ribose relaton-ogc relaton-un relaton-cen relaton-ecma relaton-etsi relaton-cie relaton-iana relaton-omg relaton-oasis relaton-jis isodoc isodoc-compile isostandard isostandard-compile isostandard-amd iec cc csa gbstandard m3d ribose ieee un ogc nist itu ietf generic iho bipm bsi jis plateau relaton-ieee-compile relaton-iso-compile relaton-iec-compile relaton-bsi-compile relaton-gb-compile relaton-mpfa-compile relaton-bipm-compile relaton-w3c-compile relaton-3gpp-compile relaton-csa-compile relaton-cc-compile relaton-ietf-compile relaton-iho-compile relaton-itu-compile relaton-m3aawg-compile relaton-nist-compile relaton-ribose-compile relaton-ogc-compile relaton-un-compile relaton-cen-compile relaton-ecma-compile relaton-etsi-compile relaton-cie-compile relaton-iana-compile relaton-omg-compile relaton-oasis-compile relaton-jis-compile
do
  echo $i
