...
cat isodoc.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/standoc" }) '> ../../metanorma-standoc/lib/asciidoctor/standoc/isodoc.rng
...
cat isostandard.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/iso" }) '>  ../../metanorma-iso/lib/asciidoctor/iso/isostandard.rng
...
cat iec.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/iec" }) '>  ../../metanorma-iec/lib/asciidoctor/iec/iec.rng
...
cat gbstandard.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/gb" }) '>  ../../metanorma-gb/lib/asciidoctor/gb/gbstandard.rng
...
cat csd.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/csd" }) '>  ../../metanorma-csd/lib/asciidoctor/csd/csd.rng
...
cat csa.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/csa" }) '>  ../../metanorma-csand/lib/asciidoctor/csa/csa.rng
...
cat m3d.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/m3d" }) '>  ../../metanorma-m3d/lib/asciidoctor/m3d/m3d.rng
...
cat rsd.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/rsd" }) '>  ../../metanorma-rsd/lib/asciidoctor/rsd/rsd.rng
...
cat rsd.rng | ruby -pe '$_.gsub!(/rsd-standard/, "sample-standard") ' | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/sample" }) '  > ../../metanorma-sample/lib/asciidoctor/sample/sample.rng
...
cat rsd.rng | ruby -pe '$_.gsub!(/rsd-standard/, "acme-standard") ' | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/acme" }) ' > ../../metanorma-acme/lib/asciidoctor/acme/acme.rng
...
cat mpfd.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/mpfd" }) '>  ../../metanorma-mpfd/lib/asciidoctor/mpfd/mpfd.rng
...
cat unece.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/unece" }) '>  ../../metanorma-unece/lib/asciidoctor/unece/unece.rng
...
cat ogc.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/ogc" }) '>  ../../metanorma-ogc/lib/asciidoctor/ogc/ogc.rng
...
cat nist.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/nist" }) '>  ../../metanorma-nist/lib/asciidoctor/nist/nist.rng
...
cat ietf.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/ietf" }) '>  ../../metanorma-ietf/lib/asciidoctor/ietf/ietf.rng
...
cat itu.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/itu" }) '>  ../../metanorma-itu/lib/asciidoctor/itu/itu.rng
...
cat rsd.rng | ruby -pe '$_.gsub!(/<grammar /, %{<grammar ns="https://www.metanorma.com/ns/vsd" }) '>  ../../metanorma-vsd/lib/asciidoctor/vsd/vsd.rng
