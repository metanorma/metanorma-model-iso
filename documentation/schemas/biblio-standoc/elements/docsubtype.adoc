...
// TODO: salvage prose for this non-terminal. The anchor `[#docsubtype]`
// above is the canonical stable ID that grammar `## @see <<docsubtype>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-docsubtype[biblio-standoc.html#define-docsubtype]
