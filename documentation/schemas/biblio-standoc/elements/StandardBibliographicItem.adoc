...
// TODO: salvage prose for this non-terminal. The anchor `[#StandardBibliographicItem]`
// above is the canonical stable ID that grammar `## @see <<StandardBibliographicItem>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-StandardBibliographicItem[biblio-standoc.html#define-StandardBibliographicItem]
