...
// TODO: salvage prose for this non-terminal. The anchor `[#DocumentImages]`
// above is the canonical stable ID that grammar `## @see <<DocumentImages>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-DocumentImages[biblio-standoc.html#define-DocumentImages]
