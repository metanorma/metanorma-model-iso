...
// TODO: salvage prose for this non-terminal. The anchor `[#MetanormaFlavor]`
// above is the canonical stable ID that grammar `## @see <<MetanormaFlavor>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-MetanormaFlavor[biblio-standoc.html#define-MetanormaFlavor]
