...
// TODO: salvage prose for this non-terminal. The anchor `[#DocumentSubtype]`
// above is the canonical stable ID that grammar `## @see <<DocumentSubtype>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-DocumentSubtype[biblio-standoc.html#define-DocumentSubtype]
