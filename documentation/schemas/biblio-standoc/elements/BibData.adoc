...
// TODO: salvage prose for this non-terminal. The anchor `[#BibData]`
// above is the canonical stable ID that grammar `## @see <<BibData>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-BibData[biblio-standoc.html#define-BibData]
