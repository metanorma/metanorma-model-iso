...
// TODO: salvage prose for this non-terminal. The anchor `[#docrelation]`
// above is the canonical stable ID that grammar `## @see <<docrelation>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-docrelation[biblio-standoc.html#define-docrelation]
