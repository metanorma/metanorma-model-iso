...
// TODO: salvage prose for this non-terminal. The anchor `[#DocumentType]`
// above is the canonical stable ID that grammar `## @see <<DocumentType>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-DocumentType[biblio-standoc.html#define-DocumentType]
