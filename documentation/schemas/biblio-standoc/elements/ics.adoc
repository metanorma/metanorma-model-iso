...
// TODO: salvage prose for this non-terminal. The anchor `[#ics]`
// above is the canonical stable ID that grammar `## @see <<ics>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-ics[biblio-standoc.html#define-ics]
