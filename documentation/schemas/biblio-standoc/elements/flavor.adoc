...
// TODO: salvage prose for this non-terminal. The anchor `[#flavor]`
// above is the canonical stable ID that grammar `## @see <<flavor>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-flavor[biblio-standoc.html#define-flavor]
