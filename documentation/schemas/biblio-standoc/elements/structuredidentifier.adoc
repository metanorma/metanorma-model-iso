...
// TODO: salvage prose for this non-terminal. The anchor `[#structuredidentifier]`
// above is the canonical stable ID that grammar `## @see <<structuredidentifier>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-structuredidentifier[biblio-standoc.html#define-structuredidentifier]
