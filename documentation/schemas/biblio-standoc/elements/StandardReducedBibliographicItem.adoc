...
= `StandardReducedBibliographicItem`
:schema: biblio-standoc

// TODO: salvage prose for this non-terminal. The anchor `[#StandardReducedBibliographicItem]`
// above is the canonical stable ID that grammar `## @see <<StandardReducedBibliographicItem>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-StandardReducedBibliographicItem[biblio-standoc.html#define-StandardReducedBibliographicItem]
