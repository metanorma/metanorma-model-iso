...
// TODO: salvage prose for this non-terminal. The anchor `[#ext]`
// above is the canonical stable ID that grammar `## @see <<ext>>`
...
See the corresponding SPA panel: link:../../../../biblio-standoc.html#define-ext[biblio-standoc.html#define-ext]
