...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-xref-label]`
// above is the canonical stable ID that grammar `## @see <<fmt-xref-label>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-xref-label[isodoc-presentation.html#define-fmt-xref-label]
