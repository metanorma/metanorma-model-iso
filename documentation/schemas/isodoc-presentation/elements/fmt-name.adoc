...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-name]`
// above is the canonical stable ID that grammar `## @see <<fmt-name>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-name[isodoc-presentation.html#define-fmt-name]
