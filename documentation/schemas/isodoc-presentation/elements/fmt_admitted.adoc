...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt_admitted]`
// above is the canonical stable ID that grammar `## @see <<fmt_admitted>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt_admitted[isodoc-presentation.html#define-fmt_admitted]
