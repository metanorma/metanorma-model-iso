...
// TODO: salvage prose for this non-terminal. The anchor `[#misccontainer]`
// above is the canonical stable ID that grammar `## @see <<misccontainer>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-misccontainer[isodoc-presentation.html#define-misccontainer]
