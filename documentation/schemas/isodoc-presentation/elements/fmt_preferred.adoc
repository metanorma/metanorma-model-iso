...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt_preferred]`
// above is the canonical stable ID that grammar `## @see <<fmt_preferred>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt_preferred[isodoc-presentation.html#define-fmt_preferred]
