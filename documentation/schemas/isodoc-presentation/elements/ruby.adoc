...
// TODO: salvage prose for this non-terminal. The anchor `[#ruby]`
// above is the canonical stable ID that grammar `## @see <<ruby>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-ruby[isodoc-presentation.html#define-ruby]
