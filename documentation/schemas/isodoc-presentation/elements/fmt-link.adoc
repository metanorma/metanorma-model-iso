...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-link]`
// above is the canonical stable ID that grammar `## @see <<fmt-link>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-link[isodoc-presentation.html#define-fmt-link]
