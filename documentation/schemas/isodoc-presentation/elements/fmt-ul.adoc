...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-ul]`
// above is the canonical stable ID that grammar `## @see <<fmt-ul>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-ul[isodoc-presentation.html#define-fmt-ul]
