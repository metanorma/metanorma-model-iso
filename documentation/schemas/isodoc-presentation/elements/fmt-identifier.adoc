...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-identifier]`
// above is the canonical stable ID that grammar `## @see <<fmt-identifier>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-identifier[isodoc-presentation.html#define-fmt-identifier]
