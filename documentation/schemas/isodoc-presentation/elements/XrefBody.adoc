...
// TODO: salvage prose for this non-terminal. The anchor `[#XrefBody]`
// above is the canonical stable ID that grammar `## @see <<XrefBody>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-XrefBody[isodoc-presentation.html#define-XrefBody]
