...
// TODO: salvage prose for this non-terminal. The anchor `[#section-title]`
// above is the canonical stable ID that grammar `## @see <<section-title>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-section-title[isodoc-presentation.html#define-section-title]
