...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-fn-body]`
// above is the canonical stable ID that grammar `## @see <<fmt-fn-body>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-fn-body[isodoc-presentation.html#define-fmt-fn-body]
