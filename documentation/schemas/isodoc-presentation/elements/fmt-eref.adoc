...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-eref]`
// above is the canonical stable ID that grammar `## @see <<fmt-eref>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-eref[isodoc-presentation.html#define-fmt-eref]
