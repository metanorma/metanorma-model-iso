...
// TODO: salvage prose for this non-terminal. The anchor `[#source-highlighter-css]`
// above is the canonical stable ID that grammar `## @see <<source-highlighter-css>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-source-highlighter-css[isodoc-presentation.html#define-source-highlighter-css]
