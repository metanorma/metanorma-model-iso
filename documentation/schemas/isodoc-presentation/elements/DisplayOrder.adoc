...
// TODO: salvage prose for this non-terminal. The anchor `[#DisplayOrder]`
// above is the canonical stable ID that grammar `## @see <<DisplayOrder>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-DisplayOrder[isodoc-presentation.html#define-DisplayOrder]
