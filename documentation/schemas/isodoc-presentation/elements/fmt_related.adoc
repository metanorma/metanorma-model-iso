...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt_related]`
// above is the canonical stable ID that grammar `## @see <<fmt_related>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt_related[isodoc-presentation.html#define-fmt_related]
