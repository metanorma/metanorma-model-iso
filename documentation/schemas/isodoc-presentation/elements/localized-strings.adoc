...
// TODO: salvage prose for this non-terminal. The anchor `[#localized-strings]`
// above is the canonical stable ID that grammar `## @see <<localized-strings>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-localized-strings[isodoc-presentation.html#define-localized-strings]
