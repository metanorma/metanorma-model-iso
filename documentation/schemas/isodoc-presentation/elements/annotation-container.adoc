...
// TODO: salvage prose for this non-terminal. The anchor `[#annotation-container]`
// above is the canonical stable ID that grammar `## @see <<annotation-container>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-annotation-container[isodoc-presentation.html#define-annotation-container]
