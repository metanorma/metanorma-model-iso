...
// TODO: salvage prose for this non-terminal. The anchor `[#semx]`
// above is the canonical stable ID that grammar `## @see <<semx>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-semx[isodoc-presentation.html#define-semx]
