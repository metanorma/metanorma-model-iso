...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-sourcecode]`
// above is the canonical stable ID that grammar `## @see <<fmt-sourcecode>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-sourcecode[isodoc-presentation.html#define-fmt-sourcecode]
