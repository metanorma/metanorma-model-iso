...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-fn-label]`
// above is the canonical stable ID that grammar `## @see <<fmt-fn-label>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-fn-label[isodoc-presentation.html#define-fmt-fn-label]
