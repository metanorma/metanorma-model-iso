...
// TODO: salvage prose for this non-terminal. The anchor `[#FormulaBody]`
// above is the canonical stable ID that grammar `## @see <<FormulaBody>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-FormulaBody[isodoc-presentation.html#define-FormulaBody]
