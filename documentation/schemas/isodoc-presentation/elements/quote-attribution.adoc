...
// TODO: salvage prose for this non-terminal. The anchor `[#quote-attribution]`
// above is the canonical stable ID that grammar `## @see <<quote-attribution>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-quote-attribution[isodoc-presentation.html#define-quote-attribution]
