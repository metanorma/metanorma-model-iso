...
// TODO: salvage prose for this non-terminal. The anchor `[#sourcelocalityStack]`
// above is the canonical stable ID that grammar `## @see <<sourcelocalityStack>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-sourcelocalityStack[isodoc-presentation.html#define-sourcelocalityStack]
