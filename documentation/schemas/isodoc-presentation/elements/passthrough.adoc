...
// TODO: salvage prose for this non-terminal. The anchor `[#passthrough]`
// above is the canonical stable ID that grammar `## @see <<passthrough>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-passthrough[isodoc-presentation.html#define-passthrough]
