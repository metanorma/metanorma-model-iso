...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-ol]`
// above is the canonical stable ID that grammar `## @see <<fmt-ol>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-ol[isodoc-presentation.html#define-fmt-ol]
