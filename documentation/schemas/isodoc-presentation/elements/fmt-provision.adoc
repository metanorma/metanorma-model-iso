...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-provision]`
// above is the canonical stable ID that grammar `## @see <<fmt-provision>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-provision[isodoc-presentation.html#define-fmt-provision]
