...
// TODO: salvage prose for this non-terminal. The anchor `[#biblio-tag]`
// above is the canonical stable ID that grammar `## @see <<biblio-tag>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-biblio-tag[isodoc-presentation.html#define-biblio-tag]
