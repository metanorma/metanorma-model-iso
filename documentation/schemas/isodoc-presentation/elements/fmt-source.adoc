...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-source]`
// above is the canonical stable ID that grammar `## @see <<fmt-source>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-source[isodoc-presentation.html#define-fmt-source]
