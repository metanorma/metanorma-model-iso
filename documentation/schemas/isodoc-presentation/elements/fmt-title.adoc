...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-title]`
// above is the canonical stable ID that grammar `## @see <<fmt-title>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-title[isodoc-presentation.html#define-fmt-title]
