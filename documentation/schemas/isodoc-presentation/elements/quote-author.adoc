...
// TODO: salvage prose for this non-terminal. The anchor `[#quote-author]`
// above is the canonical stable ID that grammar `## @see <<quote-author>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-quote-author[isodoc-presentation.html#define-quote-author]
