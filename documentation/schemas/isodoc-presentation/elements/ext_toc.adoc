...
// TODO: salvage prose for this non-terminal. The anchor `[#ext_toc]`
// above is the canonical stable ID that grammar `## @see <<ext_toc>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-ext_toc[isodoc-presentation.html#define-ext_toc]
