...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-annotation-end]`
// above is the canonical stable ID that grammar `## @see <<fmt-annotation-end>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-annotation-end[isodoc-presentation.html#define-fmt-annotation-end]
