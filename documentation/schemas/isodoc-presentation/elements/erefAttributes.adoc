...
// TODO: salvage prose for this non-terminal. The anchor `[#erefAttributes]`
// above is the canonical stable ID that grammar `## @see <<erefAttributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-erefAttributes[isodoc-presentation.html#define-erefAttributes]
