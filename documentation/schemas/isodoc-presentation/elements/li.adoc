...
// TODO: salvage prose for this non-terminal. The anchor `[#li]`
// above is the canonical stable ID that grammar `## @see <<li>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-li[isodoc-presentation.html#define-li]
