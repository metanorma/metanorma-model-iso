...
// TODO: salvage prose for this non-terminal. The anchor `[#image]`
// above is the canonical stable ID that grammar `## @see <<image>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-image[isodoc-presentation.html#define-image]
