...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-footnote-container]`
// above is the canonical stable ID that grammar `## @see <<fmt-footnote-container>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-footnote-container[isodoc-presentation.html#define-fmt-footnote-container]
