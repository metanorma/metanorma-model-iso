...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-date-inline]`
// above is the canonical stable ID that grammar `## @see <<fmt-date-inline>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-date-inline[isodoc-presentation.html#define-fmt-date-inline]
