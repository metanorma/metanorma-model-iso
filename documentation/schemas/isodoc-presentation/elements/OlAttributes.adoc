...
// TODO: salvage prose for this non-terminal. The anchor `[#OlAttributes]`
// above is the canonical stable ID that grammar `## @see <<OlAttributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-OlAttributes[isodoc-presentation.html#define-OlAttributes]
