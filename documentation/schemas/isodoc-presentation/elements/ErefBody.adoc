...
// TODO: salvage prose for this non-terminal. The anchor `[#ErefBody]`
// above is the canonical stable ID that grammar `## @see <<ErefBody>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-ErefBody[isodoc-presentation.html#define-ErefBody]
