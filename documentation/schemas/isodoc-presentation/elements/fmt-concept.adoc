...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-concept]`
// above is the canonical stable ID that grammar `## @see <<fmt-concept>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-concept[isodoc-presentation.html#define-fmt-concept]
