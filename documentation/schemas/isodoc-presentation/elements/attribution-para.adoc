...
// TODO: salvage prose for this non-terminal. The anchor `[#attribution-para]`
// above is the canonical stable ID that grammar `## @see <<attribution-para>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-attribution-para[isodoc-presentation.html#define-attribution-para]
