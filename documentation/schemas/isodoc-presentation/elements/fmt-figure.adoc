...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-figure]`
// above is the canonical stable ID that grammar `## @see <<fmt-figure>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-figure[isodoc-presentation.html#define-fmt-figure]
