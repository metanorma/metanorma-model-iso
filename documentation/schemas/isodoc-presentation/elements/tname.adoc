...
// TODO: salvage prose for this non-terminal. The anchor `[#tname]`
// above is the canonical stable ID that grammar `## @see <<tname>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-tname[isodoc-presentation.html#define-tname]
