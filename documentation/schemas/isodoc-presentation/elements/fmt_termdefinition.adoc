...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt_termdefinition]`
// above is the canonical stable ID that grammar `## @see <<fmt_termdefinition>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt_termdefinition[isodoc-presentation.html#define-fmt_termdefinition]
