...
// TODO: salvage prose for this non-terminal. The anchor `[#term]`
// above is the canonical stable ID that grammar `## @see <<term>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-term[isodoc-presentation.html#define-term]
