...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-stem]`
// above is the canonical stable ID that grammar `## @see <<fmt-stem>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-stem[isodoc-presentation.html#define-fmt-stem]
