...
// TODO: salvage prose for this non-terminal. The anchor `[#sections]`
// above is the canonical stable ID that grammar `## @see <<sections>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-sections[isodoc-presentation.html#define-sections]
