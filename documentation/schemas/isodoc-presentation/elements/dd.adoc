...
// TODO: salvage prose for this non-terminal. The anchor `[#dd]`
// above is the canonical stable ID that grammar `## @see <<dd>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-dd[isodoc-presentation.html#define-dd]
