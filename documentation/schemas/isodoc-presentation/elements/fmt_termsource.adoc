...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt_termsource]`
// above is the canonical stable ID that grammar `## @see <<fmt_termsource>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt_termsource[isodoc-presentation.html#define-fmt_termsource]
