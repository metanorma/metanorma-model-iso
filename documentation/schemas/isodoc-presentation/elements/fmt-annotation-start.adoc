...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-annotation-start]`
// above is the canonical stable ID that grammar `## @see <<fmt-annotation-start>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-annotation-start[isodoc-presentation.html#define-fmt-annotation-start]
