...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-annotation-body]`
// above is the canonical stable ID that grammar `## @see <<fmt-annotation-body>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-annotation-body[isodoc-presentation.html#define-fmt-annotation-body]
