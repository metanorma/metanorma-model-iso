...
// TODO: salvage prose for this non-terminal. The anchor `[#tab]`
// above is the canonical stable ID that grammar `## @see <<tab>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-tab[isodoc-presentation.html#define-tab]
