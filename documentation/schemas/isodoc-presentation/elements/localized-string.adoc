...
// TODO: salvage prose for this non-terminal. The anchor `[#localized-string]`
// above is the canonical stable ID that grammar `## @see <<localized-string>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-localized-string[isodoc-presentation.html#define-localized-string]
