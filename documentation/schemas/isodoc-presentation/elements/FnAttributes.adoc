...
// TODO: salvage prose for this non-terminal. The anchor `[#FnAttributes]`
// above is the canonical stable ID that grammar `## @see <<FnAttributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-FnAttributes[isodoc-presentation.html#define-FnAttributes]
