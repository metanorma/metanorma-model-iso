...
// TODO: salvage prose for this non-terminal. The anchor `[#LiBody]`
// above is the canonical stable ID that grammar `## @see <<LiBody>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-LiBody[isodoc-presentation.html#define-LiBody]
