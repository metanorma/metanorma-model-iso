...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt_deprecates]`
// above is the canonical stable ID that grammar `## @see <<fmt_deprecates>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt_deprecates[isodoc-presentation.html#define-fmt_deprecates]
