...
// TODO: salvage prose for this non-terminal. The anchor `[#fmt-origin]`
// above is the canonical stable ID that grammar `## @see <<fmt-origin>>`
...
See the corresponding SPA panel: link:../../../../isodoc-presentation.html#define-fmt-origin[isodoc-presentation.html#define-fmt-origin]
