...
// TODO: salvage prose for this non-terminal. The anchor `[#BibliographicItem]`
// above is the canonical stable ID that grammar `## @see <<BibliographicItem>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-BibliographicItem[biblio-presentation.html#define-BibliographicItem]
