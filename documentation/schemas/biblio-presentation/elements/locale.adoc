...
// TODO: salvage prose for this non-terminal. The anchor `[#locale]`
// above is the canonical stable ID that grammar `## @see <<locale>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-locale[biblio-presentation.html#define-locale]
