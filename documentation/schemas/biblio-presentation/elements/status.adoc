...
// TODO: salvage prose for this non-terminal. The anchor `[#status]`
// above is the canonical stable ID that grammar `## @see <<status>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-status[biblio-presentation.html#define-status]
