...
// TODO: salvage prose for this non-terminal. The anchor `[#localityStack]`
// above is the canonical stable ID that grammar `## @see <<localityStack>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-localityStack[biblio-presentation.html#define-localityStack]
