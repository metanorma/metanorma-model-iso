...
= `BibDataExtensionType`
:schema: biblio-presentation

// TODO: salvage prose for this non-terminal. The anchor `[#BibDataExtensionType]`
// above is the canonical stable ID that grammar `## @see <<BibDataExtensionType>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-BibDataExtensionType[biblio-presentation.html#define-BibDataExtensionType]
