...
// TODO: salvage prose for this non-terminal. The anchor `[#doctype]`
// above is the canonical stable ID that grammar `## @see <<doctype>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-doctype[biblio-presentation.html#define-doctype]
