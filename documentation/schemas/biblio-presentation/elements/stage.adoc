...
// TODO: salvage prose for this non-terminal. The anchor `[#stage]`
// above is the canonical stable ID that grammar `## @see <<stage>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-stage[biblio-presentation.html#define-stage]
