...
// TODO: salvage prose for this non-terminal. The anchor `[#language]`
// above is the canonical stable ID that grammar `## @see <<language>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-language[biblio-presentation.html#define-language]
