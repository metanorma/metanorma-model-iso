...
// TODO: salvage prose for this non-terminal. The anchor `[#edition]`
// above is the canonical stable ID that grammar `## @see <<edition>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-edition[biblio-presentation.html#define-edition]
