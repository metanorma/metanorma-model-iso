...
// TODO: salvage prose for this non-terminal. The anchor `[#substage]`
// above is the canonical stable ID that grammar `## @see <<substage>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-substage[biblio-presentation.html#define-substage]
