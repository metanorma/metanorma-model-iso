...
// TODO: salvage prose for this non-terminal. The anchor `[#script]`
// above is the canonical stable ID that grammar `## @see <<script>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-script[biblio-presentation.html#define-script]
