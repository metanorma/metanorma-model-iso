...
// TODO: salvage prose for this non-terminal. The anchor `[#address]`
// above is the canonical stable ID that grammar `## @see <<address>>`
...
See the corresponding SPA panel: link:../../../../biblio-presentation.html#define-address[biblio-presentation.html#define-address]
