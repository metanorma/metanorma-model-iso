...
// TODO: salvage prose for this non-terminal. The anchor `[#ruby_pronunciation]`
// above is the canonical stable ID that grammar `## @see <<ruby_pronunciation>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ruby_pronunciation[basicdoc.html#define-ruby_pronunciation]
