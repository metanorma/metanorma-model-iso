...
// TODO: salvage prose for this non-terminal. The anchor `[#strong]`
// above is the canonical stable ID that grammar `## @see <<strong>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-strong[basicdoc.html#define-strong]
