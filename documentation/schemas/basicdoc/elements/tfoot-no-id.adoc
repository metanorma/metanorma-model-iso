...
// TODO: salvage prose for this non-terminal. The anchor `[#tfoot-no-id]`
// above is the canonical stable ID that grammar `## @see <<tfoot-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-tfoot-no-id[basicdoc.html#define-tfoot-no-id]
