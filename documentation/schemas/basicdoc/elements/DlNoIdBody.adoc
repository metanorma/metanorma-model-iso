...
// TODO: salvage prose for this non-terminal. The anchor `[#DlNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<DlNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-DlNoIdBody[basicdoc.html#define-DlNoIdBody]
