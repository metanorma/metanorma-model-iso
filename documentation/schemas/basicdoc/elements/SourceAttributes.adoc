...
// TODO: salvage prose for this non-terminal. The anchor `[#SourceAttributes]`
// above is the canonical stable ID that grammar `## @see <<SourceAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-SourceAttributes[basicdoc.html#define-SourceAttributes]
