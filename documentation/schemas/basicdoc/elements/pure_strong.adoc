...
// TODO: salvage prose for this non-terminal. The anchor `[#pure_strong]`
// above is the canonical stable ID that grammar `## @see <<pure_strong>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-pure_strong[basicdoc.html#define-pure_strong]
