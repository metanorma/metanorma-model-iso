...
// TODO: salvage prose for this non-terminal. The anchor `[#TableAttributes]`
// above is the canonical stable ID that grammar `## @see <<TableAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-TableAttributes[basicdoc.html#define-TableAttributes]
