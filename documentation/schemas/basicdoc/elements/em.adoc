...
// TODO: salvage prose for this non-terminal. The anchor `[#em]`
// above is the canonical stable ID that grammar `## @see <<em>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-em[basicdoc.html#define-em]
