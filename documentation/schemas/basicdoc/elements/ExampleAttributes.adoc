...
// TODO: salvage prose for this non-terminal. The anchor `[#ExampleAttributes]`
// above is the canonical stable ID that grammar `## @see <<ExampleAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ExampleAttributes[basicdoc.html#define-ExampleAttributes]
