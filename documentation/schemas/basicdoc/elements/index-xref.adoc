...
// TODO: salvage prose for this non-terminal. The anchor `[#index-xref]`
// above is the canonical stable ID that grammar `## @see <<index-xref>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-index-xref[basicdoc.html#define-index-xref]
