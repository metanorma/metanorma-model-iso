...
// TODO: salvage prose for this non-terminal. The anchor `[#figure]`
// above is the canonical stable ID that grammar `## @see <<figure>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-figure[basicdoc.html#define-figure]
