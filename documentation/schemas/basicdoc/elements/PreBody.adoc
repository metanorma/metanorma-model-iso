...
// TODO: salvage prose for this non-terminal. The anchor `[#PreBody]`
// above is the canonical stable ID that grammar `## @see <<PreBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-PreBody[basicdoc.html#define-PreBody]
