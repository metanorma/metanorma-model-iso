...
// TODO: salvage prose for this non-terminal. The anchor `[#classification_tag]`
// above is the canonical stable ID that grammar `## @see <<classification_tag>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-classification_tag[basicdoc.html#define-classification_tag]
