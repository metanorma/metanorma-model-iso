...
// TODO: salvage prose for this non-terminal. The anchor `[#dl]`
// above is the canonical stable ID that grammar `## @see <<dl>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-dl[basicdoc.html#define-dl]
