...
// TODO: salvage prose for this non-terminal. The anchor `[#pure_smallcap]`
// above is the canonical stable ID that grammar `## @see <<pure_smallcap>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-pure_smallcap[basicdoc.html#define-pure_smallcap]
