...
// TODO: salvage prose for this non-terminal. The anchor `[#TableBody]`
// above is the canonical stable ID that grammar `## @see <<TableBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-TableBody[basicdoc.html#define-TableBody]
