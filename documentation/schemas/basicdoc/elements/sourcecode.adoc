...
// TODO: salvage prose for this non-terminal. The anchor `[#sourcecode]`
// above is the canonical stable ID that grammar `## @see <<sourcecode>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-sourcecode[basicdoc.html#define-sourcecode]
