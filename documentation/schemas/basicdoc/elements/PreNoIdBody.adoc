...
// TODO: salvage prose for this non-terminal. The anchor `[#PreNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<PreNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-PreNoIdBody[basicdoc.html#define-PreNoIdBody]
