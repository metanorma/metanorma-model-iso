...
// TODO: salvage prose for this non-terminal. The anchor `[#li-no-id]`
// above is the canonical stable ID that grammar `## @see <<li-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-li-no-id[basicdoc.html#define-li-no-id]
