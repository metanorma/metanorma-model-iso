...
// TODO: salvage prose for this non-terminal. The anchor `[#FigureNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<FigureNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-FigureNoIdBody[basicdoc.html#define-FigureNoIdBody]
