...
// TODO: salvage prose for this non-terminal. The anchor `[#classification]`
// above is the canonical stable ID that grammar `## @see <<classification>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-classification[basicdoc.html#define-classification]
