...
// TODO: salvage prose for this non-terminal. The anchor `[#ThAttributes]`
// above is the canonical stable ID that grammar `## @see <<ThAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ThAttributes[basicdoc.html#define-ThAttributes]
