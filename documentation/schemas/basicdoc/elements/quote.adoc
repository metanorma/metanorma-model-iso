...
// TODO: salvage prose for this non-terminal. The anchor `[#quote]`
// above is the canonical stable ID that grammar `## @see <<quote>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-quote[basicdoc.html#define-quote]
