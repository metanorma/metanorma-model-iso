...
// TODO: salvage prose for this non-terminal. The anchor `[#eref]`
// above is the canonical stable ID that grammar `## @see <<eref>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-eref[basicdoc.html#define-eref]
