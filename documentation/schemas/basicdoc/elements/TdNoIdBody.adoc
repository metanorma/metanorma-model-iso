...
// TODO: salvage prose for this non-terminal. The anchor `[#TdNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<TdNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-TdNoIdBody[basicdoc.html#define-TdNoIdBody]
