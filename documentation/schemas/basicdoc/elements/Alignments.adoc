...
// TODO: salvage prose for this non-terminal. The anchor `[#Alignments]`
// above is the canonical stable ID that grammar `## @see <<Alignments>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-Alignments[basicdoc.html#define-Alignments]
