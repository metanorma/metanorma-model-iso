...
// TODO: salvage prose for this non-terminal. The anchor `[#UlAttributes]`
// above is the canonical stable ID that grammar `## @see <<UlAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-UlAttributes[basicdoc.html#define-UlAttributes]
