...
// TODO: salvage prose for this non-terminal. The anchor `[#sourcecodebody]`
// above is the canonical stable ID that grammar `## @see <<sourcecodebody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-sourcecodebody[basicdoc.html#define-sourcecodebody]
