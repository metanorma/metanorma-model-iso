...
// TODO: salvage prose for this non-terminal. The anchor `[#review]`
// above is the canonical stable ID that grammar `## @see <<review>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-review[basicdoc.html#define-review]
