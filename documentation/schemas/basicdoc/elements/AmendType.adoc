...
// TODO: salvage prose for this non-terminal. The anchor `[#AmendType]`
// above is the canonical stable ID that grammar `## @see <<AmendType>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-AmendType[basicdoc.html#define-AmendType]
