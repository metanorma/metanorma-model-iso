...
// TODO: salvage prose for this non-terminal. The anchor `[#MIMEType]`
// above is the canonical stable ID that grammar `## @see <<MIMEType>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-MIMEType[basicdoc.html#define-MIMEType]
