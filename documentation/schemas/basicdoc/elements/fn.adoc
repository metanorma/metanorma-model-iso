...
// TODO: salvage prose for this non-terminal. The anchor `[#fn]`
// above is the canonical stable ID that grammar `## @see <<fn>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-fn[basicdoc.html#define-fn]
