...
// TODO: salvage prose for this non-terminal. The anchor `[#paragraph-with-footnote]`
// above is the canonical stable ID that grammar `## @see <<paragraph-with-footnote>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-paragraph-with-footnote[basicdoc.html#define-paragraph-with-footnote]
