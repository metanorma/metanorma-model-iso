...
// TODO: salvage prose for this non-terminal. The anchor `[#index-secondary]`
// above is the canonical stable ID that grammar `## @see <<index-secondary>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-index-secondary[basicdoc.html#define-index-secondary]
