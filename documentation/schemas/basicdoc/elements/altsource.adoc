...
// TODO: salvage prose for this non-terminal. The anchor `[#altsource]`
// above is the canonical stable ID that grammar `## @see <<altsource>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-altsource[basicdoc.html#define-altsource]
