...
// TODO: salvage prose for this non-terminal. The anchor `[#NumberingAttributes]`
// above is the canonical stable ID that grammar `## @see <<NumberingAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-NumberingAttributes[basicdoc.html#define-NumberingAttributes]
