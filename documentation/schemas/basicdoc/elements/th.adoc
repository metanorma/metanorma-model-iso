...
// TODO: salvage prose for this non-terminal. The anchor `[#th]`
// above is the canonical stable ID that grammar `## @see <<th>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-th[basicdoc.html#define-th]
