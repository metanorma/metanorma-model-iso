...
// TODO: salvage prose for this non-terminal. The anchor `[#UlNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<UlNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-UlNoIdBody[basicdoc.html#define-UlNoIdBody]
