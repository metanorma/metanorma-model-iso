...
// TODO: salvage prose for this non-terminal. The anchor `[#tbody]`
// above is the canonical stable ID that grammar `## @see <<tbody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-tbody[basicdoc.html#define-tbody]
