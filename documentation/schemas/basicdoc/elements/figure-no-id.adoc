...
// TODO: salvage prose for this non-terminal. The anchor `[#figure-no-id]`
// above is the canonical stable ID that grammar `## @see <<figure-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-figure-no-id[basicdoc.html#define-figure-no-id]
