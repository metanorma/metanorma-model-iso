...
// TODO: salvage prose for this non-terminal. The anchor `[#index-primary]`
// above is the canonical stable ID that grammar `## @see <<index-primary>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-index-primary[basicdoc.html#define-index-primary]
