...
// TODO: salvage prose for this non-terminal. The anchor `[#paragraph]`
// above is the canonical stable ID that grammar `## @see <<paragraph>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-paragraph[basicdoc.html#define-paragraph]
