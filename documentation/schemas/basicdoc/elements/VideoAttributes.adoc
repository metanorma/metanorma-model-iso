...
// TODO: salvage prose for this non-terminal. The anchor `[#VideoAttributes]`
// above is the canonical stable ID that grammar `## @see <<VideoAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-VideoAttributes[basicdoc.html#define-VideoAttributes]
