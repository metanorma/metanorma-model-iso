...
// TODO: salvage prose for this non-terminal. The anchor `[#AdmonitionBody]`
// above is the canonical stable ID that grammar `## @see <<AdmonitionBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-AdmonitionBody[basicdoc.html#define-AdmonitionBody]
