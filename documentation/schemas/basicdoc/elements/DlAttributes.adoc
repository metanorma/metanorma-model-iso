...
// TODO: salvage prose for this non-terminal. The anchor `[#DlAttributes]`
// above is the canonical stable ID that grammar `## @see <<DlAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-DlAttributes[basicdoc.html#define-DlAttributes]
