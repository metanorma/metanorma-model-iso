...
// TODO: salvage prose for this non-terminal. The anchor `[#tfoot]`
// above is the canonical stable ID that grammar `## @see <<tfoot>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-tfoot[basicdoc.html#define-tfoot]
