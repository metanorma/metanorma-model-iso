...
// TODO: salvage prose for this non-terminal. The anchor `[#td-no-id]`
// above is the canonical stable ID that grammar `## @see <<td-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-td-no-id[basicdoc.html#define-td-no-id]
