...
// TODO: salvage prose for this non-terminal. The anchor `[#TextElement]`
// above is the canonical stable ID that grammar `## @see <<TextElement>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-TextElement[basicdoc.html#define-TextElement]
