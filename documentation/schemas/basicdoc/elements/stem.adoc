...
// TODO: salvage prose for this non-terminal. The anchor `[#stem]`
// above is the canonical stable ID that grammar `## @see <<stem>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-stem[basicdoc.html#define-stem]
