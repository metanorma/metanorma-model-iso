...
// TODO: salvage prose for this non-terminal. The anchor `[#dd-no-id]`
// above is the canonical stable ID that grammar `## @see <<dd-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-dd-no-id[basicdoc.html#define-dd-no-id]
