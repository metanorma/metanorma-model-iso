...
// TODO: salvage prose for this non-terminal. The anchor `[#smallcap]`
// above is the canonical stable ID that grammar `## @see <<smallcap>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-smallcap[basicdoc.html#define-smallcap]
