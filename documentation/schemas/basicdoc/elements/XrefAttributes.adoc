...
// TODO: salvage prose for this non-terminal. The anchor `[#XrefAttributes]`
// above is the canonical stable ID that grammar `## @see <<XrefAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-XrefAttributes[basicdoc.html#define-XrefAttributes]
