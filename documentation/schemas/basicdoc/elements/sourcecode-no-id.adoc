...
// TODO: salvage prose for this non-terminal. The anchor `[#sourcecode-no-id]`
// above is the canonical stable ID that grammar `## @see <<sourcecode-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-sourcecode-no-id[basicdoc.html#define-sourcecode-no-id]
