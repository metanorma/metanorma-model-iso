...
// TODO: salvage prose for this non-terminal. The anchor `[#LiAttributes]`
// above is the canonical stable ID that grammar `## @see <<LiAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-LiAttributes[basicdoc.html#define-LiAttributes]
