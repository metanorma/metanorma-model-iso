...
// TODO: salvage prose for this non-terminal. The anchor `[#strike]`
// above is the canonical stable ID that grammar `## @see <<strike>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-strike[basicdoc.html#define-strike]
