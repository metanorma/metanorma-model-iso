...
// TODO: salvage prose for this non-terminal. The anchor `[#ScriptType]`
// above is the canonical stable ID that grammar `## @see <<ScriptType>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ScriptType[basicdoc.html#define-ScriptType]
