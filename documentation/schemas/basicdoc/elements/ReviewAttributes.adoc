...
// TODO: salvage prose for this non-terminal. The anchor `[#ReviewAttributes]`
// above is the canonical stable ID that grammar `## @see <<ReviewAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ReviewAttributes[basicdoc.html#define-ReviewAttributes]
