...
// TODO: salvage prose for this non-terminal. The anchor `[#pagebreak]`
// above is the canonical stable ID that grammar `## @see <<pagebreak>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-pagebreak[basicdoc.html#define-pagebreak]
