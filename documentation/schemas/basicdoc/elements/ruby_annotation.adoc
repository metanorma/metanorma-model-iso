...
// TODO: salvage prose for this non-terminal. The anchor `[#ruby_annotation]`
// above is the canonical stable ID that grammar `## @see <<ruby_annotation>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ruby_annotation[basicdoc.html#define-ruby_annotation]
