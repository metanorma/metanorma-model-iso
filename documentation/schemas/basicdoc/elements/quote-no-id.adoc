...
// TODO: salvage prose for this non-terminal. The anchor `[#quote-no-id]`
// above is the canonical stable ID that grammar `## @see <<quote-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-quote-no-id[basicdoc.html#define-quote-no-id]
