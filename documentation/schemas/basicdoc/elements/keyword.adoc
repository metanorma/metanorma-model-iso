...
// TODO: salvage prose for this non-terminal. The anchor `[#keyword]`
// above is the canonical stable ID that grammar `## @see <<keyword>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-keyword[basicdoc.html#define-keyword]
