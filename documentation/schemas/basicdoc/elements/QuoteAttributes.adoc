...
// TODO: salvage prose for this non-terminal. The anchor `[#QuoteAttributes]`
// above is the canonical stable ID that grammar `## @see <<QuoteAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-QuoteAttributes[basicdoc.html#define-QuoteAttributes]
