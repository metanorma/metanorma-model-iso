...
// TODO: salvage prose for this non-terminal. The anchor `[#source]`
// above is the canonical stable ID that grammar `## @see <<source>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-source[basicdoc.html#define-source]
