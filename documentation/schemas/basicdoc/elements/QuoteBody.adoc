...
// TODO: salvage prose for this non-terminal. The anchor `[#QuoteBody]`
// above is the canonical stable ID that grammar `## @see <<QuoteBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-QuoteBody[basicdoc.html#define-QuoteBody]
