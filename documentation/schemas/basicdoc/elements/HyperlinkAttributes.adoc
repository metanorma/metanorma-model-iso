...
// TODO: salvage prose for this non-terminal. The anchor `[#HyperlinkAttributes]`
// above is the canonical stable ID that grammar `## @see <<HyperlinkAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-HyperlinkAttributes[basicdoc.html#define-HyperlinkAttributes]
