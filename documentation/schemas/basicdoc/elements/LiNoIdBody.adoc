...
// TODO: salvage prose for this non-terminal. The anchor `[#LiNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<LiNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-LiNoIdBody[basicdoc.html#define-LiNoIdBody]
