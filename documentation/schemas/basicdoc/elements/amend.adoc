...
// TODO: salvage prose for this non-terminal. The anchor `[#amend]`
// above is the canonical stable ID that grammar `## @see <<amend>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-amend[basicdoc.html#define-amend]
