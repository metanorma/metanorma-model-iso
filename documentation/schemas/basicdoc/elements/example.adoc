...
// TODO: salvage prose for this non-terminal. The anchor `[#example]`
// above is the canonical stable ID that grammar `## @see <<example>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-example[basicdoc.html#define-example]
