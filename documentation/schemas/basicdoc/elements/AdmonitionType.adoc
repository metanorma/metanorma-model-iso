...
// TODO: salvage prose for this non-terminal. The anchor `[#AdmonitionType]`
// above is the canonical stable ID that grammar `## @see <<AdmonitionType>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-AdmonitionType[basicdoc.html#define-AdmonitionType]
