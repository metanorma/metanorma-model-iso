...
// TODO: salvage prose for this non-terminal. The anchor `[#MediaAttributes]`
// above is the canonical stable ID that grammar `## @see <<MediaAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-MediaAttributes[basicdoc.html#define-MediaAttributes]
