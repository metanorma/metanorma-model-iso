...
// TODO: salvage prose for this non-terminal. The anchor `[#callout]`
// above is the canonical stable ID that grammar `## @see <<callout>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-callout[basicdoc.html#define-callout]
