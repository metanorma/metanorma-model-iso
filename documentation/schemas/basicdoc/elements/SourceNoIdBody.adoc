...
// TODO: salvage prose for this non-terminal. The anchor `[#SourceNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<SourceNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-SourceNoIdBody[basicdoc.html#define-SourceNoIdBody]
