...
// TODO: salvage prose for this non-terminal. The anchor `[#annotation]`
// above is the canonical stable ID that grammar `## @see <<annotation>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-annotation[basicdoc.html#define-annotation]
