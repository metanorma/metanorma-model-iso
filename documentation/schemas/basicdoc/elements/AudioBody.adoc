...
// TODO: salvage prose for this non-terminal. The anchor `[#AudioBody]`
// above is the canonical stable ID that grammar `## @see <<AudioBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-AudioBody[basicdoc.html#define-AudioBody]
