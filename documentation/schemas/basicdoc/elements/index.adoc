...
// TODO: salvage prose for this non-terminal. The anchor `[#index]`
// above is the canonical stable ID that grammar `## @see <<index>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-index[basicdoc.html#define-index]
