...
// TODO: salvage prose for this non-terminal. The anchor `[#dt]`
// above is the canonical stable ID that grammar `## @see <<dt>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-dt[basicdoc.html#define-dt]
