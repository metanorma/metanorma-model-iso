...
// TODO: salvage prose for this non-terminal. The anchor `[#note]`
// above is the canonical stable ID that grammar `## @see <<note>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-note[basicdoc.html#define-note]
