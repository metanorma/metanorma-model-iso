...
// TODO: salvage prose for this non-terminal. The anchor `[#ThNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<ThNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ThNoIdBody[basicdoc.html#define-ThNoIdBody]
