...
// TODO: salvage prose for this non-terminal. The anchor `[#formula-no-id]`
// above is the canonical stable ID that grammar `## @see <<formula-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-formula-no-id[basicdoc.html#define-formula-no-id]
