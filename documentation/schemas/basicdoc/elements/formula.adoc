...
// TODO: salvage prose for this non-terminal. The anchor `[#formula]`
// above is the canonical stable ID that grammar `## @see <<formula>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-formula[basicdoc.html#define-formula]
