...
// TODO: salvage prose for this non-terminal. The anchor `[#FormulaAttributes]`
// above is the canonical stable ID that grammar `## @see <<FormulaAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-FormulaAttributes[basicdoc.html#define-FormulaAttributes]
