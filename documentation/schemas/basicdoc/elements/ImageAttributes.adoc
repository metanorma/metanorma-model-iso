...
// TODO: salvage prose for this non-terminal. The anchor `[#ImageAttributes]`
// above is the canonical stable ID that grammar `## @see <<ImageAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ImageAttributes[basicdoc.html#define-ImageAttributes]
