...
// TODO: salvage prose for this non-terminal. The anchor `[#ParagraphType]`
// above is the canonical stable ID that grammar `## @see <<ParagraphType>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ParagraphType[basicdoc.html#define-ParagraphType]
