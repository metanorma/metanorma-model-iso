...
// TODO: salvage prose for this non-terminal. The anchor `[#thead]`
// above is the canonical stable ID that grammar `## @see <<thead>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-thead[basicdoc.html#define-thead]
