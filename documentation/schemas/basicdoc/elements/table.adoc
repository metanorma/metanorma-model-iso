...
// TODO: salvage prose for this non-terminal. The anchor `[#table]`
// above is the canonical stable ID that grammar `## @see <<table>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-table[basicdoc.html#define-table]
