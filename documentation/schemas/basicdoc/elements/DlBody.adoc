...
// TODO: salvage prose for this non-terminal. The anchor `[#DlBody]`
// above is the canonical stable ID that grammar `## @see <<DlBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-DlBody[basicdoc.html#define-DlBody]
