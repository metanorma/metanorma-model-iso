...
// TODO: salvage prose for this non-terminal. The anchor `[#td]`
// above is the canonical stable ID that grammar `## @see <<td>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-td[basicdoc.html#define-td]
