...
// TODO: salvage prose for this non-terminal. The anchor `[#ul-no-id]`
// above is the canonical stable ID that grammar `## @see <<ul-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ul-no-id[basicdoc.html#define-ul-no-id]
