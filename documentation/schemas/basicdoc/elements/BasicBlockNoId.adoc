...
// TODO: salvage prose for this non-terminal. The anchor `[#BasicBlockNoId]`
// above is the canonical stable ID that grammar `## @see <<BasicBlockNoId>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-BasicBlockNoId[basicdoc.html#define-BasicBlockNoId]
