...
// TODO: salvage prose for this non-terminal. The anchor `[#paragraph-no-id]`
// above is the canonical stable ID that grammar `## @see <<paragraph-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-paragraph-no-id[basicdoc.html#define-paragraph-no-id]
