...
// TODO: salvage prose for this non-terminal. The anchor `[#PreAttributes]`
// above is the canonical stable ID that grammar `## @see <<PreAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-PreAttributes[basicdoc.html#define-PreAttributes]
