...
// TODO: salvage prose for this non-terminal. The anchor `[#underline]`
// above is the canonical stable ID that grammar `## @see <<underline>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-underline[basicdoc.html#define-underline]
