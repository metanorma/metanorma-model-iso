...
// TODO: salvage prose for this non-terminal. The anchor `[#pure_underline]`
// above is the canonical stable ID that grammar `## @see <<pure_underline>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-pure_underline[basicdoc.html#define-pure_underline]
