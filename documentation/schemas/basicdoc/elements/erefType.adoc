...
// TODO: salvage prose for this non-terminal. The anchor `[#erefType]`
// above is the canonical stable ID that grammar `## @see <<erefType>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-erefType[basicdoc.html#define-erefType]
