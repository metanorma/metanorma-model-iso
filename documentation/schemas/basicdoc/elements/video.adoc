...
// TODO: salvage prose for this non-terminal. The anchor `[#video]`
// above is the canonical stable ID that grammar `## @see <<video>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-video[basicdoc.html#define-video]
