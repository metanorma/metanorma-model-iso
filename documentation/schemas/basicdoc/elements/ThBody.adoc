...
// TODO: salvage prose for this non-terminal. The anchor `[#ThBody]`
// above is the canonical stable ID that grammar `## @see <<ThBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ThBody[basicdoc.html#define-ThBody]
