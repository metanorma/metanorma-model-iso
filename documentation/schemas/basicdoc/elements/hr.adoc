...
// TODO: salvage prose for this non-terminal. The anchor `[#hr]`
// above is the canonical stable ID that grammar `## @see <<hr>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-hr[basicdoc.html#define-hr]
