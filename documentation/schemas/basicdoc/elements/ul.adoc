...
// TODO: salvage prose for this non-terminal. The anchor `[#ul]`
// above is the canonical stable ID that grammar `## @see <<ul>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ul[basicdoc.html#define-ul]
