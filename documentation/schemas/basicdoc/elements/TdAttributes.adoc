...
// TODO: salvage prose for this non-terminal. The anchor `[#TdAttributes]`
// above is the canonical stable ID that grammar `## @see <<TdAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-TdAttributes[basicdoc.html#define-TdAttributes]
