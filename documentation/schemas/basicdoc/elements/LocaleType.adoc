...
// TODO: salvage prose for this non-terminal. The anchor `[#LocaleType]`
// above is the canonical stable ID that grammar `## @see <<LocaleType>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-LocaleType[basicdoc.html#define-LocaleType]
