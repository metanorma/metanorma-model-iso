...
// TODO: salvage prose for this non-terminal. The anchor `[#ImageSize]`
// above is the canonical stable ID that grammar `## @see <<ImageSize>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ImageSize[basicdoc.html#define-ImageSize]
