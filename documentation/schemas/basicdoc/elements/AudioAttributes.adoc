...
// TODO: salvage prose for this non-terminal. The anchor `[#AudioAttributes]`
// above is the canonical stable ID that grammar `## @see <<AudioAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-AudioAttributes[basicdoc.html#define-AudioAttributes]
