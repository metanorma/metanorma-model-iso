...
// TODO: salvage prose for this non-terminal. The anchor `[#section]`
// above is the canonical stable ID that grammar `## @see <<section>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-section[basicdoc.html#define-section]
