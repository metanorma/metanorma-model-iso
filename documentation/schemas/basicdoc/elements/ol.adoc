...
// TODO: salvage prose for this non-terminal. The anchor `[#ol]`
// above is the canonical stable ID that grammar `## @see <<ol>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ol[basicdoc.html#define-ol]
