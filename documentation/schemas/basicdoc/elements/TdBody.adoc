...
// TODO: salvage prose for this non-terminal. The anchor `[#TdBody]`
// above is the canonical stable ID that grammar `## @see <<TdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-TdBody[basicdoc.html#define-TdBody]
