...
// TODO: salvage prose for this non-terminal. The anchor `[#NestedTextElement]`
// above is the canonical stable ID that grammar `## @see <<NestedTextElement>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-NestedTextElement[basicdoc.html#define-NestedTextElement]
