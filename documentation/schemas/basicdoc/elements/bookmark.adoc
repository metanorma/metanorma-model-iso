...
// TODO: salvage prose for this non-terminal. The anchor `[#bookmark]`
// above is the canonical stable ID that grammar `## @see <<bookmark>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-bookmark[basicdoc.html#define-bookmark]
