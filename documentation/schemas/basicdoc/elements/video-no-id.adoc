...
// TODO: salvage prose for this non-terminal. The anchor `[#video-no-id]`
// above is the canonical stable ID that grammar `## @see <<video-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-video-no-id[basicdoc.html#define-video-no-id]
