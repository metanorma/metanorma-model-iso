...
// TODO: salvage prose for this non-terminal. The anchor `[#RequiredId]`
// above is the canonical stable ID that grammar `## @see <<RequiredId>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-RequiredId[basicdoc.html#define-RequiredId]
