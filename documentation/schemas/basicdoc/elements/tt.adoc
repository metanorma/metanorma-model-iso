...
// TODO: salvage prose for this non-terminal. The anchor `[#tt]`
// above is the canonical stable ID that grammar `## @see <<tt>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-tt[basicdoc.html#define-tt]
