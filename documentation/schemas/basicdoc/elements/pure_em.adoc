...
// TODO: salvage prose for this non-terminal. The anchor `[#pure_em]`
// above is the canonical stable ID that grammar `## @see <<pure_em>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-pure_em[basicdoc.html#define-pure_em]
