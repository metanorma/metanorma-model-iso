...
// TODO: salvage prose for this non-terminal. The anchor `[#pre]`
// above is the canonical stable ID that grammar `## @see <<pre>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-pre[basicdoc.html#define-pre]
