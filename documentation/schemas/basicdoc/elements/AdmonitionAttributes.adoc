...
// TODO: salvage prose for this non-terminal. The anchor `[#AdmonitionAttributes]`
// above is the canonical stable ID that grammar `## @see <<AdmonitionAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-AdmonitionAttributes[basicdoc.html#define-AdmonitionAttributes]
