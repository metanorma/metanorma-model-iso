...
// TODO: salvage prose for this non-terminal. The anchor `[#table-note]`
// above is the canonical stable ID that grammar `## @see <<table-note>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-table-note[basicdoc.html#define-table-note]
