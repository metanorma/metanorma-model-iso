...
// TODO: salvage prose for this non-terminal. The anchor `[#TrAttributes]`
// above is the canonical stable ID that grammar `## @see <<TrAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-TrAttributes[basicdoc.html#define-TrAttributes]
