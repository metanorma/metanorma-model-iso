...
// TODO: salvage prose for this non-terminal. The anchor `[#OptionalId]`
// above is the canonical stable ID that grammar `## @see <<OptionalId>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-OptionalId[basicdoc.html#define-OptionalId]
