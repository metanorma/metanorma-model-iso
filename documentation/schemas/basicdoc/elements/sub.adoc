...
// TODO: salvage prose for this non-terminal. The anchor `[#sub]`
// above is the canonical stable ID that grammar `## @see <<sub>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-sub[basicdoc.html#define-sub]
