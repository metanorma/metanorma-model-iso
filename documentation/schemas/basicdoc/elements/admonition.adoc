...
// TODO: salvage prose for this non-terminal. The anchor `[#admonition]`
// above is the canonical stable ID that grammar `## @see <<admonition>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-admonition[basicdoc.html#define-admonition]
