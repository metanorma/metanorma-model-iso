...
// TODO: salvage prose for this non-terminal. The anchor `[#admonition-no-id]`
// above is the canonical stable ID that grammar `## @see <<admonition-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-admonition-no-id[basicdoc.html#define-admonition-no-id]
