...
// TODO: salvage prose for this non-terminal. The anchor `[#ExampleBody]`
// above is the canonical stable ID that grammar `## @see <<ExampleBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ExampleBody[basicdoc.html#define-ExampleBody]
