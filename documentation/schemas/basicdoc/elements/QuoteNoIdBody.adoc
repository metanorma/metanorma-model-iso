...
// TODO: salvage prose for this non-terminal. The anchor `[#QuoteNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<QuoteNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-QuoteNoIdBody[basicdoc.html#define-QuoteNoIdBody]
