...
// TODO: salvage prose for this non-terminal. The anchor `[#ol-no-id]`
// above is the canonical stable ID that grammar `## @see <<ol-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ol-no-id[basicdoc.html#define-ol-no-id]
