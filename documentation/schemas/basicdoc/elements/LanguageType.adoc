...
// TODO: salvage prose for this non-terminal. The anchor `[#LanguageType]`
// above is the canonical stable ID that grammar `## @see <<LanguageType>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-LanguageType[basicdoc.html#define-LanguageType]
