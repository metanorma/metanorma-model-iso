...
// TODO: salvage prose for this non-terminal. The anchor `[#ParagraphAttributes]`
// above is the canonical stable ID that grammar `## @see <<ParagraphAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ParagraphAttributes[basicdoc.html#define-ParagraphAttributes]
