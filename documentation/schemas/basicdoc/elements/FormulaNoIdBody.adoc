...
// TODO: salvage prose for this non-terminal. The anchor `[#FormulaNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<FormulaNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-FormulaNoIdBody[basicdoc.html#define-FormulaNoIdBody]
