...
// TODO: salvage prose for this non-terminal. The anchor `[#PureTextElement]`
// above is the canonical stable ID that grammar `## @see <<PureTextElement>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-PureTextElement[basicdoc.html#define-PureTextElement]
