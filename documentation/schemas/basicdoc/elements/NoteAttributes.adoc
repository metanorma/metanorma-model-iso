...
// TODO: salvage prose for this non-terminal. The anchor `[#NoteAttributes]`
// above is the canonical stable ID that grammar `## @see <<NoteAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-NoteAttributes[basicdoc.html#define-NoteAttributes]
