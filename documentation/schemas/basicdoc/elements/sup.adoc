...
// TODO: salvage prose for this non-terminal. The anchor `[#sup]`
// above is the canonical stable ID that grammar `## @see <<sup>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-sup[basicdoc.html#define-sup]
