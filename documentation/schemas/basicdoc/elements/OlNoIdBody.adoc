...
// TODO: salvage prose for this non-terminal. The anchor `[#OlNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<OlNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-OlNoIdBody[basicdoc.html#define-OlNoIdBody]
