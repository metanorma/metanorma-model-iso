...
// TODO: salvage prose for this non-terminal. The anchor `[#audio]`
// above is the canonical stable ID that grammar `## @see <<audio>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-audio[basicdoc.html#define-audio]
