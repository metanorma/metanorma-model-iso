...
// TODO: salvage prose for this non-terminal. The anchor `[#table-no-id]`
// above is the canonical stable ID that grammar `## @see <<table-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-table-no-id[basicdoc.html#define-table-no-id]
