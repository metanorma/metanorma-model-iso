...
// TODO: salvage prose for this non-terminal. The anchor `[#Basic-Section]`
// above is the canonical stable ID that grammar `## @see <<Basic-Section>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-Basic-Section[basicdoc.html#define-Basic-Section]
