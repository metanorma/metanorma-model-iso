...
// TODO: salvage prose for this non-terminal. The anchor `[#tr]`
// above is the canonical stable ID that grammar `## @see <<tr>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-tr[basicdoc.html#define-tr]
