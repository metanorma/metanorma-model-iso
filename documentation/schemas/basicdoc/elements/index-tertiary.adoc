...
// TODO: salvage prose for this non-terminal. The anchor `[#index-tertiary]`
// above is the canonical stable ID that grammar `## @see <<index-tertiary>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-index-tertiary[basicdoc.html#define-index-tertiary]
