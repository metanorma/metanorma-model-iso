...
// TODO: salvage prose for this non-terminal. The anchor `[#th-no-id]`
// above is the canonical stable ID that grammar `## @see <<th-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-th-no-id[basicdoc.html#define-th-no-id]
