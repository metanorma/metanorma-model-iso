...
// TODO: salvage prose for this non-terminal. The anchor `[#ExampleNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<ExampleNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ExampleNoIdBody[basicdoc.html#define-ExampleNoIdBody]
