...
// TODO: salvage prose for this non-terminal. The anchor `[#ReferenceFormat]`
// above is the canonical stable ID that grammar `## @see <<ReferenceFormat>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ReferenceFormat[basicdoc.html#define-ReferenceFormat]
