...
// TODO: salvage prose for this non-terminal. The anchor `[#dl-no-id]`
// above is the canonical stable ID that grammar `## @see <<dl-no-id>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-dl-no-id[basicdoc.html#define-dl-no-id]
