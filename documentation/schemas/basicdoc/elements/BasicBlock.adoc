...
// TODO: salvage prose for this non-terminal. The anchor `[#BasicBlock]`
// above is the canonical stable ID that grammar `## @see <<BasicBlock>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-BasicBlock[basicdoc.html#define-BasicBlock]
