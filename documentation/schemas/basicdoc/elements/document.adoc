...
// TODO: salvage prose for this non-terminal. The anchor `[#document]`
// above is the canonical stable ID that grammar `## @see <<document>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-document[basicdoc.html#define-document]
