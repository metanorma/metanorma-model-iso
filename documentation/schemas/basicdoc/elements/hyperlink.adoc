...
// TODO: salvage prose for this non-terminal. The anchor `[#hyperlink]`
// above is the canonical stable ID that grammar `## @see <<hyperlink>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-hyperlink[basicdoc.html#define-hyperlink]
