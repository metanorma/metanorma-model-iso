...
// TODO: salvage prose for this non-terminal. The anchor `[#br]`
// above is the canonical stable ID that grammar `## @see <<br>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-br[basicdoc.html#define-br]
