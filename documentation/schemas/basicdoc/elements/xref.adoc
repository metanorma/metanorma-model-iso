...
// TODO: salvage prose for this non-terminal. The anchor `[#xref]`
// above is the canonical stable ID that grammar `## @see <<xref>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-xref[basicdoc.html#define-xref]
