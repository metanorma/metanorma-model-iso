...
// TODO: salvage prose for this non-terminal. The anchor `[#pure_strike]`
// above is the canonical stable ID that grammar `## @see <<pure_strike>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-pure_strike[basicdoc.html#define-pure_strike]
