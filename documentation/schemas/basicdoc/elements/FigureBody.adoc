...
// TODO: salvage prose for this non-terminal. The anchor `[#FigureBody]`
// above is the canonical stable ID that grammar `## @see <<FigureBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-FigureBody[basicdoc.html#define-FigureBody]
