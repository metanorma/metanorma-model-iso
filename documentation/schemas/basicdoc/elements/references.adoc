...
// TODO: salvage prose for this non-terminal. The anchor `[#references]`
// above is the canonical stable ID that grammar `## @see <<references>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-references[basicdoc.html#define-references]
