...
// TODO: salvage prose for this non-terminal. The anchor `[#ParagraphFnBody]`
// above is the canonical stable ID that grammar `## @see <<ParagraphFnBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ParagraphFnBody[basicdoc.html#define-ParagraphFnBody]
