...
// TODO: salvage prose for this non-terminal. The anchor `[#StemAttributes]`
// above is the canonical stable ID that grammar `## @see <<StemAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-StemAttributes[basicdoc.html#define-StemAttributes]
