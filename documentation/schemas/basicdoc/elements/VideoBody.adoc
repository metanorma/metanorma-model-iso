...
// TODO: salvage prose for this non-terminal. The anchor `[#VideoBody]`
// above is the canonical stable ID that grammar `## @see <<VideoBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-VideoBody[basicdoc.html#define-VideoBody]
