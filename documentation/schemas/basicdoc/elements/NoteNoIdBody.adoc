...
// TODO: salvage prose for this non-terminal. The anchor `[#NoteNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<NoteNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-NoteNoIdBody[basicdoc.html#define-NoteNoIdBody]
