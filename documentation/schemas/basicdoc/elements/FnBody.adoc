...
// TODO: salvage prose for this non-terminal. The anchor `[#FnBody]`
// above is the canonical stable ID that grammar `## @see <<FnBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-FnBody[basicdoc.html#define-FnBody]
