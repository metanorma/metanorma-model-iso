...
// TODO: salvage prose for this non-terminal. The anchor `[#AdmonitionNoIdBody]`
// above is the canonical stable ID that grammar `## @see <<AdmonitionNoIdBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-AdmonitionNoIdBody[basicdoc.html#define-AdmonitionNoIdBody]
