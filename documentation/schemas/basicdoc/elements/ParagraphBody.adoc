...
// TODO: salvage prose for this non-terminal. The anchor `[#ParagraphBody]`
// above is the canonical stable ID that grammar `## @see <<ParagraphBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-ParagraphBody[basicdoc.html#define-ParagraphBody]
