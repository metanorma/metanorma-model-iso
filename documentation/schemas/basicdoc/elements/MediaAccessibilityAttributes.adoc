...
// TODO: salvage prose for this non-terminal. The anchor `[#MediaAccessibilityAttributes]`
// above is the canonical stable ID that grammar `## @see <<MediaAccessibilityAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-MediaAccessibilityAttributes[basicdoc.html#define-MediaAccessibilityAttributes]
