...
// TODO: salvage prose for this non-terminal. The anchor `[#UlBody]`
// above is the canonical stable ID that grammar `## @see <<UlBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-UlBody[basicdoc.html#define-UlBody]
