...
// TODO: salvage prose for this non-terminal. The anchor `[#OlBody]`
// above is the canonical stable ID that grammar `## @see <<OlBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-OlBody[basicdoc.html#define-OlBody]
