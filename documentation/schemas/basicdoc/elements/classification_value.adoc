...
// TODO: salvage prose for this non-terminal. The anchor `[#classification_value]`
// above is the canonical stable ID that grammar `## @see <<classification_value>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-classification_value[basicdoc.html#define-classification_value]
