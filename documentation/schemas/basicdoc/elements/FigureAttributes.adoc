...
// TODO: salvage prose for this non-terminal. The anchor `[#FigureAttributes]`
// above is the canonical stable ID that grammar `## @see <<FigureAttributes>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-FigureAttributes[basicdoc.html#define-FigureAttributes]
