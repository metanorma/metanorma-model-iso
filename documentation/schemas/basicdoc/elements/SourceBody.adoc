...
// TODO: salvage prose for this non-terminal. The anchor `[#SourceBody]`
// above is the canonical stable ID that grammar `## @see <<SourceBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-SourceBody[basicdoc.html#define-SourceBody]
