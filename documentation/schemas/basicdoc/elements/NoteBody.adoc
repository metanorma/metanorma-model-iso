...
// TODO: salvage prose for this non-terminal. The anchor `[#NoteBody]`
// above is the canonical stable ID that grammar `## @see <<NoteBody>>`
...
See the corresponding SPA panel: link:../../../../basicdoc.html#define-NoteBody[basicdoc.html#define-NoteBody]
