...
// TODO: salvage prose for this non-terminal. The anchor `[#svgmap]`
// above is the canonical stable ID that grammar `## @see <<svgmap>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-svgmap[isodoc.html#define-svgmap]
