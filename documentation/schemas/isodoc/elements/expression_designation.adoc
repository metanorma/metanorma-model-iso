...
// TODO: salvage prose for this non-terminal. The anchor `[#expression_designation]`
// above is the canonical stable ID that grammar `## @see <<expression_designation>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-expression_designation[isodoc.html#define-expression_designation]
