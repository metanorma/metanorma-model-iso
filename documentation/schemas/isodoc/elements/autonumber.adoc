...
// TODO: salvage prose for this non-terminal. The anchor `[#autonumber]`
// above is the canonical stable ID that grammar `## @see <<autonumber>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-autonumber[isodoc.html#define-autonumber]
