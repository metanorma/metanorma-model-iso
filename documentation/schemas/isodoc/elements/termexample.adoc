...
// TODO: salvage prose for this non-terminal. The anchor `[#termexample]`
// above is the canonical stable ID that grammar `## @see <<termexample>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-termexample[isodoc.html#define-termexample]
