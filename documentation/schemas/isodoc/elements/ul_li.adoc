...
// TODO: salvage prose for this non-terminal. The anchor `[#ul_li]`
// above is the canonical stable ID that grammar `## @see <<ul_li>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-ul_li[isodoc.html#define-ul_li]
