...
// TODO: salvage prose for this non-terminal. The anchor `[#col]`
// above is the canonical stable ID that grammar `## @see <<col>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-col[isodoc.html#define-col]
