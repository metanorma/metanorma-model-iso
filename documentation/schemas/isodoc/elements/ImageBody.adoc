...
// TODO: salvage prose for this non-terminal. The anchor `[#ImageBody]`
// above is the canonical stable ID that grammar `## @see <<ImageBody>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-ImageBody[isodoc.html#define-ImageBody]
