...
// TODO: salvage prose for this non-terminal. The anchor `[#introduction]`
// above is the canonical stable ID that grammar `## @see <<introduction>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-introduction[isodoc.html#define-introduction]
