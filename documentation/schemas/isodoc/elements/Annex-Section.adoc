...
// TODO: salvage prose for this non-terminal. The anchor `[#Annex-Section]`
// above is the canonical stable ID that grammar `## @see <<Annex-Section>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-Annex-Section[isodoc.html#define-Annex-Section]
