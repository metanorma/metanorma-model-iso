...
// TODO: salvage prose for this non-terminal. The anchor `[#clause]`
// above is the canonical stable ID that grammar `## @see <<clause>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-clause[isodoc.html#define-clause]
