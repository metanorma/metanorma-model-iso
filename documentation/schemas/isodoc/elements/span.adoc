...
// TODO: salvage prose for this non-terminal. The anchor `[#span]`
// above is the canonical stable ID that grammar `## @see <<span>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-span[isodoc.html#define-span]
