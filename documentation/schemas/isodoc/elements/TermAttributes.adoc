...
// TODO: salvage prose for this non-terminal. The anchor `[#TermAttributes]`
// above is the canonical stable ID that grammar `## @see <<TermAttributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-TermAttributes[isodoc.html#define-TermAttributes]
