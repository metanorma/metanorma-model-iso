...
// TODO: salvage prose for this non-terminal. The anchor `[#add]`
// above is the canonical stable ID that grammar `## @see <<add>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-add[isodoc.html#define-add]
