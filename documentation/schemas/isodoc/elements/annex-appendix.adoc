...
// TODO: salvage prose for this non-terminal. The anchor `[#annex-appendix]`
// above is the canonical stable ID that grammar `## @see <<annex-appendix>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-annex-appendix[isodoc.html#define-annex-appendix]
