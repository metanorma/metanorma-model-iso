...
// TODO: salvage prose for this non-terminal. The anchor `[#UlLiAttributes]`
// above is the canonical stable ID that grammar `## @see <<UlLiAttributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-UlLiAttributes[isodoc.html#define-UlLiAttributes]
