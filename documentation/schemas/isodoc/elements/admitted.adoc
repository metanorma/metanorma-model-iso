...
// TODO: salvage prose for this non-terminal. The anchor `[#admitted]`
// above is the canonical stable ID that grammar `## @see <<admitted>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-admitted[isodoc.html#define-admitted]
