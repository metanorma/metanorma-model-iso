...
// TODO: salvage prose for this non-terminal. The anchor `[#content-subsection]`
// above is the canonical stable ID that grammar `## @see <<content-subsection>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-content-subsection[isodoc.html#define-content-subsection]
