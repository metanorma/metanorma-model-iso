...
// TODO: salvage prose for this non-terminal. The anchor `[#foreword]`
// above is the canonical stable ID that grammar `## @see <<foreword>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-foreword[isodoc.html#define-foreword]
