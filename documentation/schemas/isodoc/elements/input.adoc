...
// TODO: salvage prose for this non-terminal. The anchor `[#input]`
// above is the canonical stable ID that grammar `## @see <<input>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-input[isodoc.html#define-input]
