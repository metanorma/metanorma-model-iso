...
// TODO: salvage prose for this non-terminal. The anchor `[#colgroup]`
// above is the canonical stable ID that grammar `## @see <<colgroup>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-colgroup[isodoc.html#define-colgroup]
