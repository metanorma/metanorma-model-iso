...
// TODO: salvage prose for this non-terminal. The anchor `[#term-clause]`
// above is the canonical stable ID that grammar `## @see <<term-clause>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-term-clause[isodoc.html#define-term-clause]
