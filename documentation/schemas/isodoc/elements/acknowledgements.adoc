...
// TODO: salvage prose for this non-terminal. The anchor `[#acknowledgements]`
// above is the canonical stable ID that grammar `## @see <<acknowledgements>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-acknowledgements[isodoc.html#define-acknowledgements]
