...
// TODO: salvage prose for this non-terminal. The anchor `[#concept]`
// above is the canonical stable ID that grammar `## @see <<concept>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-concept[isodoc.html#define-concept]
