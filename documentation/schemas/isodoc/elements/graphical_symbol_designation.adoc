...
// TODO: salvage prose for this non-terminal. The anchor `[#graphical_symbol_designation]`
// above is the canonical stable ID that grammar `## @see <<graphical_symbol_designation>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-graphical_symbol_designation[isodoc.html#define-graphical_symbol_designation]
