...
// TODO: salvage prose for this non-terminal. The anchor `[#BlockAttributes]`
// above is the canonical stable ID that grammar `## @see <<BlockAttributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-BlockAttributes[isodoc.html#define-BlockAttributes]
