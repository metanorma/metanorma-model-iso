...
// TODO: salvage prose for this non-terminal. The anchor `[#AbbreviationType]`
// above is the canonical stable ID that grammar `## @see <<AbbreviationType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-AbbreviationType[isodoc.html#define-AbbreviationType]
