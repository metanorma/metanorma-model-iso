...
// TODO: salvage prose for this non-terminal. The anchor `[#toc]`
// above is the canonical stable ID that grammar `## @see <<toc>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-toc[isodoc.html#define-toc]
