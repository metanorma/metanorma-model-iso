...
// TODO: salvage prose for this non-terminal. The anchor `[#XrefConnectiveType]`
// above is the canonical stable ID that grammar `## @see <<XrefConnectiveType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-XrefConnectiveType[isodoc.html#define-XrefConnectiveType]
