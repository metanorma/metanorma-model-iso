...
// TODO: salvage prose for this non-terminal. The anchor `[#Annex-Section-Body]`
// above is the canonical stable ID that grammar `## @see <<Annex-Section-Body>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-Annex-Section-Body[isodoc.html#define-Annex-Section-Body]
