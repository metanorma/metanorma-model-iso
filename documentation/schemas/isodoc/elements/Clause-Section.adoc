...
// TODO: salvage prose for this non-terminal. The anchor `[#Clause-Section]`
// above is the canonical stable ID that grammar `## @see <<Clause-Section>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-Clause-Section[isodoc.html#define-Clause-Section]
