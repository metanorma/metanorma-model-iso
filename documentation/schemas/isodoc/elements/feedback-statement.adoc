...
// TODO: salvage prose for this non-terminal. The anchor `[#feedback-statement]`
// above is the canonical stable ID that grammar `## @see <<feedback-statement>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-feedback-statement[isodoc.html#define-feedback-statement]
