...
// TODO: salvage prose for this non-terminal. The anchor `[#usageinfo]`
// above is the canonical stable ID that grammar `## @see <<usageinfo>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-usageinfo[isodoc.html#define-usageinfo]
