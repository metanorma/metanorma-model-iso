...
// TODO: salvage prose for this non-terminal. The anchor `[#select]`
// above is the canonical stable ID that grammar `## @see <<select>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-select[isodoc.html#define-select]
