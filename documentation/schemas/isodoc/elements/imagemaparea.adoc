...
// TODO: salvage prose for this non-terminal. The anchor `[#imagemaparea]`
// above is the canonical stable ID that grammar `## @see <<imagemaparea>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-imagemaparea[isodoc.html#define-imagemaparea]
