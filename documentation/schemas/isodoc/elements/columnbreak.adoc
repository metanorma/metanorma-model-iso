...
// TODO: salvage prose for this non-terminal. The anchor `[#columnbreak]`
// above is the canonical stable ID that grammar `## @see <<columnbreak>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-columnbreak[isodoc.html#define-columnbreak]
