...
// TODO: salvage prose for this non-terminal. The anchor `[#copyright-statement]`
// above is the canonical stable ID that grammar `## @see <<copyright-statement>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-copyright-statement[isodoc.html#define-copyright-statement]
