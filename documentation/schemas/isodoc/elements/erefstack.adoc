...
// TODO: salvage prose for this non-terminal. The anchor `[#erefstack]`
// above is the canonical stable ID that grammar `## @see <<erefstack>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-erefstack[isodoc.html#define-erefstack]
