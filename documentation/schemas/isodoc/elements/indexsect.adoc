...
// TODO: salvage prose for this non-terminal. The anchor `[#indexsect]`
// above is the canonical stable ID that grammar `## @see <<indexsect>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-indexsect[isodoc.html#define-indexsect]
