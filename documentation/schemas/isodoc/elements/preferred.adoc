...
// TODO: salvage prose for this non-terminal. The anchor `[#preferred]`
// above is the canonical stable ID that grammar `## @see <<preferred>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-preferred[isodoc.html#define-preferred]
