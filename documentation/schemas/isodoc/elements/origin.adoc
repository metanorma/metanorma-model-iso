...
// TODO: salvage prose for this non-terminal. The anchor `[#origin]`
// above is the canonical stable ID that grammar `## @see <<origin>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-origin[isodoc.html#define-origin]
