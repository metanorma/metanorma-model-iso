...
// TODO: salvage prose for this non-terminal. The anchor `[#SourceStatusType]`
// above is the canonical stable ID that grammar `## @see <<SourceStatusType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-SourceStatusType[isodoc.html#define-SourceStatusType]
