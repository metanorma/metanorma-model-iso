...
// TODO: salvage prose for this non-terminal. The anchor `[#termdocsource]`
// above is the canonical stable ID that grammar `## @see <<termdocsource>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-termdocsource[isodoc.html#define-termdocsource]
