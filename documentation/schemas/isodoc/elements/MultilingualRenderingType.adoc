...
// TODO: salvage prose for this non-terminal. The anchor `[#MultilingualRenderingType]`
// above is the canonical stable ID that grammar `## @see <<MultilingualRenderingType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-MultilingualRenderingType[isodoc.html#define-MultilingualRenderingType]
