...
// TODO: salvage prose for this non-terminal. The anchor `[#DocumentBody]`
// above is the canonical stable ID that grammar `## @see <<DocumentBody>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-DocumentBody[isodoc.html#define-DocumentBody]
