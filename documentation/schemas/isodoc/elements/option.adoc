...
// TODO: salvage prose for this non-terminal. The anchor `[#option]`
// above is the canonical stable ID that grammar `## @see <<option>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-option[isodoc.html#define-option]
