...
// TODO: salvage prose for this non-terminal. The anchor `[#colophon]`
// above is the canonical stable ID that grammar `## @see <<colophon>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-colophon[isodoc.html#define-colophon]
