...
// TODO: salvage prose for this non-terminal. The anchor `[#RelatedTermType]`
// above is the canonical stable ID that grammar `## @see <<RelatedTermType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-RelatedTermType[isodoc.html#define-RelatedTermType]
