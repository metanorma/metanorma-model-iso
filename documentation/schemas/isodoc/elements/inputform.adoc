...
// TODO: salvage prose for this non-terminal. The anchor `[#inputform]`
// above is the canonical stable ID that grammar `## @see <<inputform>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-inputform[isodoc.html#define-inputform]
