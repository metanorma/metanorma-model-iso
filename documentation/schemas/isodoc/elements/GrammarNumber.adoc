...
// TODO: salvage prose for this non-terminal. The anchor `[#GrammarNumber]`
// above is the canonical stable ID that grammar `## @see <<GrammarNumber>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-GrammarNumber[isodoc.html#define-GrammarNumber]
