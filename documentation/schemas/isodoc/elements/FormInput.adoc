...
// TODO: salvage prose for this non-terminal. The anchor `[#FormInput]`
// above is the canonical stable ID that grammar `## @see <<FormInput>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-FormInput[isodoc.html#define-FormInput]
