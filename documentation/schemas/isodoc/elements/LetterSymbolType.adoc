...
// TODO: salvage prose for this non-terminal. The anchor `[#LetterSymbolType]`
// above is the canonical stable ID that grammar `## @see <<LetterSymbolType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-LetterSymbolType[isodoc.html#define-LetterSymbolType]
