...
// TODO: salvage prose for this non-terminal. The anchor `[#XrefStyleType]`
// above is the canonical stable ID that grammar `## @see <<XrefStyleType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-XrefStyleType[isodoc.html#define-XrefStyleType]
