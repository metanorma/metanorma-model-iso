...
// TODO: salvage prose for this non-terminal. The anchor `[#erefTypeWithConnective]`
// above is the canonical stable ID that grammar `## @see <<erefTypeWithConnective>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-erefTypeWithConnective[isodoc.html#define-erefTypeWithConnective]
