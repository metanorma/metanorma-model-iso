...
// TODO: salvage prose for this non-terminal. The anchor `[#reference-clause]`
// above is the canonical stable ID that grammar `## @see <<reference-clause>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-reference-clause[isodoc.html#define-reference-clause]
