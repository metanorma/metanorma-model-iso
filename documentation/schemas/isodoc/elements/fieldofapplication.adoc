...
// TODO: salvage prose for this non-terminal. The anchor `[#fieldofapplication]`
// above is the canonical stable ID that grammar `## @see <<fieldofapplication>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-fieldofapplication[isodoc.html#define-fieldofapplication]
