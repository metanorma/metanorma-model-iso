...
// TODO: salvage prose for this non-terminal. The anchor `[#del]`
// above is the canonical stable ID that grammar `## @see <<del>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-del[isodoc.html#define-del]
