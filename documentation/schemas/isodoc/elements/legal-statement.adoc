...
// TODO: salvage prose for this non-terminal. The anchor `[#legal-statement]`
// above is the canonical stable ID that grammar `## @see <<legal-statement>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-legal-statement[isodoc.html#define-legal-statement]
