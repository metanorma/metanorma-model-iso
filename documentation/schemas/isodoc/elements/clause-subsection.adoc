...
// TODO: salvage prose for this non-terminal. The anchor `[#clause-subsection]`
// above is the canonical stable ID that grammar `## @see <<clause-subsection>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-clause-subsection[isodoc.html#define-clause-subsection]
