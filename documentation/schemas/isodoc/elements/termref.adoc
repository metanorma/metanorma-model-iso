...
// TODO: salvage prose for this non-terminal. The anchor `[#termref]`
// above is the canonical stable ID that grammar `## @see <<termref>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-termref[isodoc.html#define-termref]
