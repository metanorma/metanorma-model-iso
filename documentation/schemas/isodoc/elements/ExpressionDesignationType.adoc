...
// TODO: salvage prose for this non-terminal. The anchor `[#ExpressionDesignationType]`
// above is the canonical stable ID that grammar `## @see <<ExpressionDesignationType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-ExpressionDesignationType[isodoc.html#define-ExpressionDesignationType]
