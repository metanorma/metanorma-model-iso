...
// TODO: salvage prose for this non-terminal. The anchor `[#formlabel]`
// above is the canonical stable ID that grammar `## @see <<formlabel>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-formlabel[isodoc.html#define-formlabel]
