...
// TODO: salvage prose for this non-terminal. The anchor `[#preface]`
// above is the canonical stable ID that grammar `## @see <<preface>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-preface[isodoc.html#define-preface]
