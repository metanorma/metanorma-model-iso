...
// TODO: salvage prose for this non-terminal. The anchor `[#termnote]`
// above is the canonical stable ID that grammar `## @see <<termnote>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-termnote[isodoc.html#define-termnote]
