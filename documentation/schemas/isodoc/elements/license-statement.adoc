...
// TODO: salvage prose for this non-terminal. The anchor `[#license-statement]`
// above is the canonical stable ID that grammar `## @see <<license-statement>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-license-statement[isodoc.html#define-license-statement]
