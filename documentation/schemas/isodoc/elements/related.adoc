...
// TODO: salvage prose for this non-terminal. The anchor `[#related]`
// above is the canonical stable ID that grammar `## @see <<related>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-related[isodoc.html#define-related]
