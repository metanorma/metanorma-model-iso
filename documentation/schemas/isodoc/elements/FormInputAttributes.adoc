...
// TODO: salvage prose for this non-terminal. The anchor `[#FormInputAttributes]`
// above is the canonical stable ID that grammar `## @see <<FormInputAttributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-FormInputAttributes[isodoc.html#define-FormInputAttributes]
