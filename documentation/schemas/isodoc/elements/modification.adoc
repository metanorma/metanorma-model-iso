...
// TODO: salvage prose for this non-terminal. The anchor `[#modification]`
// above is the canonical stable ID that grammar `## @see <<modification>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-modification[isodoc.html#define-modification]
