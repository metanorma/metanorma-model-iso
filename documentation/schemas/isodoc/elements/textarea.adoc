...
// TODO: salvage prose for this non-terminal. The anchor `[#textarea]`
// above is the canonical stable ID that grammar `## @see <<textarea>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-textarea[isodoc.html#define-textarea]
