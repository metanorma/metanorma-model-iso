...
// TODO: salvage prose for this non-terminal. The anchor `[#termdefinition]`
// above is the canonical stable ID that grammar `## @see <<termdefinition>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-termdefinition[isodoc.html#define-termdefinition]
