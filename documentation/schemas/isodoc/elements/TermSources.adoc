...
// TODO: salvage prose for this non-terminal. The anchor `[#TermSources]`
// above is the canonical stable ID that grammar `## @see <<TermSources>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-TermSources[isodoc.html#define-TermSources]
