...
// TODO: salvage prose for this non-terminal. The anchor `[#nonverbalrep]`
// above is the canonical stable ID that grammar `## @see <<nonverbalrep>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-nonverbalrep[isodoc.html#define-nonverbalrep]
