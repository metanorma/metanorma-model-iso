...
// TODO: salvage prose for this non-terminal. The anchor `[#XrefTarget]`
// above is the canonical stable ID that grammar `## @see <<XrefTarget>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-XrefTarget[isodoc.html#define-XrefTarget]
