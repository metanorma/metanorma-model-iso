...
// TODO: salvage prose for this non-terminal. The anchor `[#GrammarGender]`
// above is the canonical stable ID that grammar `## @see <<GrammarGender>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-GrammarGender[isodoc.html#define-GrammarGender]
