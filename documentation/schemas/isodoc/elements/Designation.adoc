...
// TODO: salvage prose for this non-terminal. The anchor `[#Designation]`
// above is the canonical stable ID that grammar `## @see <<Designation>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-Designation[isodoc.html#define-Designation]
