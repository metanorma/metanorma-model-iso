...
// TODO: salvage prose for this non-terminal. The anchor `[#imagemap]`
// above is the canonical stable ID that grammar `## @see <<imagemap>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-imagemap[isodoc.html#define-imagemap]
