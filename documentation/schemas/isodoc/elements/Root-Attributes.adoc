...
// TODO: salvage prose for this non-terminal. The anchor `[#Root-Attributes]`
// above is the canonical stable ID that grammar `## @see <<Root-Attributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-Root-Attributes[isodoc.html#define-Root-Attributes]
