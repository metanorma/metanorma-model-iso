...
// TODO: salvage prose for this non-terminal. The anchor `[#BlockSource]`
// above is the canonical stable ID that grammar `## @see <<BlockSource>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-BlockSource[isodoc.html#define-BlockSource]
