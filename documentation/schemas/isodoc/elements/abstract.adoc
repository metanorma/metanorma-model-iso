...
// TODO: salvage prose for this non-terminal. The anchor `[#abstract]`
// above is the canonical stable ID that grammar `## @see <<abstract>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-abstract[isodoc.html#define-abstract]
