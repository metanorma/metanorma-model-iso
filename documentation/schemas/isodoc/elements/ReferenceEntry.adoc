...
// TODO: salvage prose for this non-terminal. The anchor `[#ReferenceEntry]`
// above is the canonical stable ID that grammar `## @see <<ReferenceEntry>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-ReferenceEntry[isodoc.html#define-ReferenceEntry]
