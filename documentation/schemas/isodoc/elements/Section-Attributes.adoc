...
// TODO: salvage prose for this non-terminal. The anchor `[#Section-Attributes]`
// above is the canonical stable ID that grammar `## @see <<Section-Attributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-Section-Attributes[isodoc.html#define-Section-Attributes]
