...
// TODO: salvage prose for this non-terminal. The anchor `[#ReferencesAttributes]`
// above is the canonical stable ID that grammar `## @see <<ReferencesAttributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-ReferencesAttributes[isodoc.html#define-ReferencesAttributes]
