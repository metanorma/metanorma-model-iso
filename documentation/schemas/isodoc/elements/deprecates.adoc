...
// TODO: salvage prose for this non-terminal. The anchor `[#deprecates]`
// above is the canonical stable ID that grammar `## @see <<deprecates>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-deprecates[isodoc.html#define-deprecates]
