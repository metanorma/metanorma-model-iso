...
// TODO: salvage prose for this non-terminal. The anchor `[#svg_target]`
// above is the canonical stable ID that grammar `## @see <<svg_target>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-svg_target[isodoc.html#define-svg_target]
