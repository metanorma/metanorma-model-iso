...
// TODO: salvage prose for this non-terminal. The anchor `[#ObligationType]`
// above is the canonical stable ID that grammar `## @see <<ObligationType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-ObligationType[isodoc.html#define-ObligationType]
