...
// TODO: salvage prose for this non-terminal. The anchor `[#floating-title]`
// above is the canonical stable ID that grammar `## @see <<floating-title>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-floating-title[isodoc.html#define-floating-title]
