...
// TODO: salvage prose for this non-terminal. The anchor `[#SourceTypeType]`
// above is the canonical stable ID that grammar `## @see <<SourceTypeType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-SourceTypeType[isodoc.html#define-SourceTypeType]
