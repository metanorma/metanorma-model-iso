...
// TODO: salvage prose for this non-terminal. The anchor `[#InputType]`
// above is the canonical stable ID that grammar `## @see <<InputType>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-InputType[isodoc.html#define-InputType]
