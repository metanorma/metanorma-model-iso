...
// TODO: salvage prose for this non-terminal. The anchor `[#verbaldefinition]`
// above is the canonical stable ID that grammar `## @see <<verbaldefinition>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-verbaldefinition[isodoc.html#define-verbaldefinition]
