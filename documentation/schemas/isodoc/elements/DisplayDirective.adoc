...
// TODO: salvage prose for this non-terminal. The anchor `[#DisplayDirective]`
// above is the canonical stable ID that grammar `## @see <<DisplayDirective>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-DisplayDirective[isodoc.html#define-DisplayDirective]
