...
// TODO: salvage prose for this non-terminal. The anchor `[#termdomain]`
// above is the canonical stable ID that grammar `## @see <<termdomain>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-termdomain[isodoc.html#define-termdomain]
