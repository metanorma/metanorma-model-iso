...
// TODO: salvage prose for this non-terminal. The anchor `[#letter_symbol_designation]`
// above is the canonical stable ID that grammar `## @see <<letter_symbol_designation>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-letter_symbol_designation[isodoc.html#define-letter_symbol_designation]
