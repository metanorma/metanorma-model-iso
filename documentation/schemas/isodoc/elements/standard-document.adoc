...
// TODO: salvage prose for this non-terminal. The anchor `[#standard-document]`
// above is the canonical stable ID that grammar `## @see <<standard-document>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-standard-document[isodoc.html#define-standard-document]
