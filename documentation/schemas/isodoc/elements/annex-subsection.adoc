...
// TODO: salvage prose for this non-terminal. The anchor `[#annex-subsection]`
// above is the canonical stable ID that grammar `## @see <<annex-subsection>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-annex-subsection[isodoc.html#define-annex-subsection]
