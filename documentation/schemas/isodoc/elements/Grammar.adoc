...
// TODO: salvage prose for this non-terminal. The anchor `[#Grammar]`
// above is the canonical stable ID that grammar `## @see <<Grammar>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-Grammar[isodoc.html#define-Grammar]
