...
// TODO: salvage prose for this non-terminal. The anchor `[#date_inline]`
// above is the canonical stable ID that grammar `## @see <<date_inline>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-date_inline[isodoc.html#define-date_inline]
