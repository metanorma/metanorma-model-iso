...
// TODO: salvage prose for this non-terminal. The anchor `[#Annex-Section-Attributes]`
// above is the canonical stable ID that grammar `## @see <<Annex-Section-Attributes>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-Annex-Section-Attributes[isodoc.html#define-Annex-Section-Attributes]
