...
// TODO: salvage prose for this non-terminal. The anchor `[#bibliography]`
// above is the canonical stable ID that grammar `## @see <<bibliography>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-bibliography[isodoc.html#define-bibliography]
