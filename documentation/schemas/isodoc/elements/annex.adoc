...
// TODO: salvage prose for this non-terminal. The anchor `[#annex]`
// above is the canonical stable ID that grammar `## @see <<annex>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-annex[isodoc.html#define-annex]
