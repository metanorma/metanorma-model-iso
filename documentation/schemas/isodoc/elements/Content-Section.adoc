...
// TODO: salvage prose for this non-terminal. The anchor `[#Content-Section]`
// above is the canonical stable ID that grammar `## @see <<Content-Section>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-Content-Section[isodoc.html#define-Content-Section]
