...
// TODO: salvage prose for this non-terminal. The anchor `[#termsubject]`
// above is the canonical stable ID that grammar `## @see <<termsubject>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-termsubject[isodoc.html#define-termsubject]
