...
// TODO: salvage prose for this non-terminal. The anchor `[#terms]`
// above is the canonical stable ID that grammar `## @see <<terms>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-terms[isodoc.html#define-terms]
