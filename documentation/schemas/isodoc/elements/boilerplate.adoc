...
// TODO: salvage prose for this non-terminal. The anchor `[#boilerplate]`
// above is the canonical stable ID that grammar `## @see <<boilerplate>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-boilerplate[isodoc.html#define-boilerplate]
