...
// TODO: salvage prose for this non-terminal. The anchor `[#content]`
// above is the canonical stable ID that grammar `## @see <<content>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-content[isodoc.html#define-content]
