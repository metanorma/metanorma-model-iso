...
// TODO: salvage prose for this non-terminal. The anchor `[#key]`
// above is the canonical stable ID that grammar `## @see <<key>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-key[isodoc.html#define-key]
