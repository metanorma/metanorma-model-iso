...
// TODO: salvage prose for this non-terminal. The anchor `[#definitions]`
// above is the canonical stable ID that grammar `## @see <<definitions>>`
...
See the corresponding SPA panel: link:../../../../isodoc.html#define-definitions[isodoc.html#define-definitions]
