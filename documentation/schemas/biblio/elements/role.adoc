...
// TODO: salvage prose for this non-terminal. The anchor `[#role]`
// above is the canonical stable ID that grammar `## @see <<role>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-role[biblio.html#define-role]
