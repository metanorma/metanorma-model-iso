...
// TODO: salvage prose for this non-terminal. The anchor `[#SeriesType]`
// above is the canonical stable ID that grammar `## @see <<SeriesType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-SeriesType[biblio.html#define-SeriesType]
