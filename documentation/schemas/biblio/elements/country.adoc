...
// TODO: salvage prose for this non-terminal. The anchor `[#country]`
// above is the canonical stable ID that grammar `## @see <<country>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-country[biblio.html#define-country]
