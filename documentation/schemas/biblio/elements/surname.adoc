...
// TODO: salvage prose for this non-terminal. The anchor `[#surname]`
// above is the canonical stable ID that grammar `## @see <<surname>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-surname[biblio.html#define-surname]
