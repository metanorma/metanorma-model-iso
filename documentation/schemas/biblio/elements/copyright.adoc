...
// TODO: salvage prose for this non-terminal. The anchor `[#copyright]`
// above is the canonical stable ID that grammar `## @see <<copyright>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-copyright[biblio.html#define-copyright]
