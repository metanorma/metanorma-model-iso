...
// TODO: salvage prose for this non-terminal. The anchor `[#orgname]`
// above is the canonical stable ID that grammar `## @see <<orgname>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-orgname[biblio.html#define-orgname]
