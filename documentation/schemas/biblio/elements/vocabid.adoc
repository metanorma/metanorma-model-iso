...
// TODO: salvage prose for this non-terminal. The anchor `[#vocabid]`
// above is the canonical stable ID that grammar `## @see <<vocabid>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-vocabid[biblio.html#define-vocabid]
