...
// TODO: salvage prose for this non-terminal. The anchor `[#completeName]`
// above is the canonical stable ID that grammar `## @see <<completeName>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-completeName[biblio.html#define-completeName]
