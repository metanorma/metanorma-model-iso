...
// TODO: salvage prose for this non-terminal. The anchor `[#LocalizedMarkedUpString]`
// above is the canonical stable ID that grammar `## @see <<LocalizedMarkedUpString>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-LocalizedMarkedUpString[biblio.html#define-LocalizedMarkedUpString]
