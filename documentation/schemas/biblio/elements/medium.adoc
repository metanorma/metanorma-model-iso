...
// TODO: salvage prose for this non-terminal. The anchor `[#medium]`
// above is the canonical stable ID that grammar `## @see <<medium>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-medium[biblio.html#define-medium]
