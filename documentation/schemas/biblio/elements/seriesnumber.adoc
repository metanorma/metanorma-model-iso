...
// TODO: salvage prose for this non-terminal. The anchor `[#seriesnumber]`
// above is the canonical stable ID that grammar `## @see <<seriesnumber>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-seriesnumber[biblio.html#define-seriesnumber]
