...
// TODO: salvage prose for this non-terminal. The anchor `[#organization]`
// above is the canonical stable ID that grammar `## @see <<organization>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-organization[biblio.html#define-organization]
