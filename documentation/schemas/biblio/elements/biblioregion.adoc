...
// TODO: salvage prose for this non-terminal. The anchor `[#biblioregion]`
// above is the canonical stable ID that grammar `## @see <<biblioregion>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-biblioregion[biblio.html#define-biblioregion]
