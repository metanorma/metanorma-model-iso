...
// TODO: salvage prose for this non-terminal. The anchor `[#bibitem]`
// above is the canonical stable ID that grammar `## @see <<bibitem>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bibitem[biblio.html#define-bibitem]
