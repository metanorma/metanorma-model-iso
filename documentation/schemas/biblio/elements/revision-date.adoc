...
// TODO: salvage prose for this non-terminal. The anchor `[#revision-date]`
// above is the canonical stable ID that grammar `## @see <<revision-date>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-revision-date[biblio.html#define-revision-date]
