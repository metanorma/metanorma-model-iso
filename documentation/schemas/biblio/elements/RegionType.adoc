...
// TODO: salvage prose for this non-terminal. The anchor `[#RegionType]`
// above is the canonical stable ID that grammar `## @see <<RegionType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-RegionType[biblio.html#define-RegionType]
