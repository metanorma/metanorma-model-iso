...
// TODO: salvage prose for this non-terminal. The anchor `[#uri]`
// above is the canonical stable ID that grammar `## @see <<uri>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-uri[biblio.html#define-uri]
