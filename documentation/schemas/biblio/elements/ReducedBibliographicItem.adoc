...
// TODO: salvage prose for this non-terminal. The anchor `[#ReducedBibliographicItem]`
// above is the canonical stable ID that grammar `## @see <<ReducedBibliographicItem>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-ReducedBibliographicItem[biblio.html#define-ReducedBibliographicItem]
