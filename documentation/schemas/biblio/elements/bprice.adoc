...
// TODO: salvage prose for this non-terminal. The anchor `[#bprice]`
// above is the canonical stable ID that grammar `## @see <<bprice>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bprice[biblio.html#define-bprice]
