...
// TODO: salvage prose for this non-terminal. The anchor `[#state]`
// above is the canonical stable ID that grammar `## @see <<state>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-state[biblio.html#define-state]
