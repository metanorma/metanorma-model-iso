...
// TODO: salvage prose for this non-terminal. The anchor `[#prefix]`
// above is the canonical stable ID that grammar `## @see <<prefix>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-prefix[biblio.html#define-prefix]
