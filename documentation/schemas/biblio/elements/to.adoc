...
// TODO: salvage prose for this non-terminal. The anchor `[#to]`
// above is the canonical stable ID that grammar `## @see <<to>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-to[biblio.html#define-to]
