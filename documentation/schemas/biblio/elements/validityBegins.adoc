...
// TODO: salvage prose for this non-terminal. The anchor `[#validityBegins]`
// above is the canonical stable ID that grammar `## @see <<validityBegins>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-validityBegins[biblio.html#define-validityBegins]
