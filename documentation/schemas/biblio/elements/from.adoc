...
// TODO: salvage prose for this non-terminal. The anchor `[#from]`
// above is the canonical stable ID that grammar `## @see <<from>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-from[biblio.html#define-from]
