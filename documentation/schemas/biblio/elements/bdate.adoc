...
// TODO: salvage prose for this non-terminal. The anchor `[#bdate]`
// above is the canonical stable ID that grammar `## @see <<bdate>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bdate[biblio.html#define-bdate]
