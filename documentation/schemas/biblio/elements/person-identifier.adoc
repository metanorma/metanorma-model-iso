...
// TODO: salvage prose for this non-terminal. The anchor `[#person-identifier]`
// above is the canonical stable ID that grammar `## @see <<person-identifier>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-person-identifier[biblio.html#define-person-identifier]
