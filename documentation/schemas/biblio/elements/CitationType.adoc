...
// TODO: salvage prose for this non-terminal. The anchor `[#CitationType]`
// above is the canonical stable ID that grammar `## @see <<CitationType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-CitationType[biblio.html#define-CitationType]
