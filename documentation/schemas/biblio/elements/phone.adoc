...
// TODO: salvage prose for this non-terminal. The anchor `[#phone]`
// above is the canonical stable ID that grammar `## @see <<phone>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-phone[biblio.html#define-phone]
