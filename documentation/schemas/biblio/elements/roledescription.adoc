...
// TODO: salvage prose for this non-terminal. The anchor `[#roledescription]`
// above is the canonical stable ID that grammar `## @see <<roledescription>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-roledescription[biblio.html#define-roledescription]
