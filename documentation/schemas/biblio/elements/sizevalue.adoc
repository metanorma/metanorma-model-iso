...
// TODO: salvage prose for this non-terminal. The anchor `[#sizevalue]`
// above is the canonical stable ID that grammar `## @see <<sizevalue>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-sizevalue[biblio.html#define-sizevalue]
