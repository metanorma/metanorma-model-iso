...
// TODO: salvage prose for this non-terminal. The anchor `[#formattedAddress]`
// above is the canonical stable ID that grammar `## @see <<formattedAddress>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-formattedAddress[biblio.html#define-formattedAddress]
