...
// TODO: salvage prose for this non-terminal. The anchor `[#license]`
// above is the canonical stable ID that grammar `## @see <<license>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-license[biblio.html#define-license]
