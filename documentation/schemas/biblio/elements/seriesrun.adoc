...
// TODO: salvage prose for this non-terminal. The anchor `[#seriesrun]`
// above is the canonical stable ID that grammar `## @see <<seriesrun>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-seriesrun[biblio.html#define-seriesrun]
