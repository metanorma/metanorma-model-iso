...
// TODO: salvage prose for this non-terminal. The anchor `[#bibliographic_size]`
// above is the canonical stable ID that grammar `## @see <<bibliographic_size>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bibliographic_size[biblio.html#define-bibliographic_size]
