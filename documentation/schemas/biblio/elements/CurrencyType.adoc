...
// TODO: salvage prose for this non-terminal. The anchor `[#CurrencyType]`
// above is the canonical stable ID that grammar `## @see <<CurrencyType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-CurrencyType[biblio.html#define-CurrencyType]
