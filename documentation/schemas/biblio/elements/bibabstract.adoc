...
// TODO: salvage prose for this non-terminal. The anchor `[#bibabstract]`
// above is the canonical stable ID that grammar `## @see <<bibabstract>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bibabstract[biblio.html#define-bibabstract]
