...
// TODO: salvage prose for this non-terminal. The anchor `[#validity]`
// above is the canonical stable ID that grammar `## @see <<validity>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-validity[biblio.html#define-validity]
