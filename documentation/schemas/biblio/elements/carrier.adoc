...
// TODO: salvage prose for this non-terminal. The anchor `[#carrier]`
// above is the canonical stable ID that grammar `## @see <<carrier>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-carrier[biblio.html#define-carrier]
