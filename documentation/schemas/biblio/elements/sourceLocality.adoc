...
// TODO: salvage prose for this non-terminal. The anchor `[#sourceLocality]`
// above is the canonical stable ID that grammar `## @see <<sourceLocality>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-sourceLocality[biblio.html#define-sourceLocality]
