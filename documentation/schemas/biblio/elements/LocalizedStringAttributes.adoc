...
// TODO: salvage prose for this non-terminal. The anchor `[#LocalizedStringAttributes]`
// above is the canonical stable ID that grammar `## @see <<LocalizedStringAttributes>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-LocalizedStringAttributes[biblio.html#define-LocalizedStringAttributes]
