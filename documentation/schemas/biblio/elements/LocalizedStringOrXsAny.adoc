...
// TODO: salvage prose for this non-terminal. The anchor `[#LocalizedStringOrXsAny]`
// above is the canonical stable ID that grammar `## @see <<LocalizedStringOrXsAny>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-LocalizedStringOrXsAny[biblio.html#define-LocalizedStringOrXsAny]
