...
// TODO: salvage prose for this non-terminal. The anchor `[#OrganizationType]`
// above is the canonical stable ID that grammar `## @see <<OrganizationType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-OrganizationType[biblio.html#define-OrganizationType]
