...
// TODO: salvage prose for this non-terminal. The anchor `[#logo]`
// above is the canonical stable ID that grammar `## @see <<logo>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-logo[biblio.html#define-logo]
