...
// TODO: salvage prose for this non-terminal. The anchor `[#bDateAttributes]`
// above is the canonical stable ID that grammar `## @see <<bDateAttributes>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bDateAttributes[biblio.html#define-bDateAttributes]
