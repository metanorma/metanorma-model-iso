...
// TODO: salvage prose for this non-terminal. The anchor `[#addition]`
// above is the canonical stable ID that grammar `## @see <<addition>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-addition[biblio.html#define-addition]
