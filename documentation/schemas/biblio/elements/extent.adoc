...
// TODO: salvage prose for this non-terminal. The anchor `[#extent]`
// above is the canonical stable ID that grammar `## @see <<extent>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-extent[biblio.html#define-extent]
