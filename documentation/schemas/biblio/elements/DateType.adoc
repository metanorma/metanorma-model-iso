...
// TODO: salvage prose for this non-terminal. The anchor `[#DateType]`
// above is the canonical stable ID that grammar `## @see <<DateType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-DateType[biblio.html#define-DateType]
