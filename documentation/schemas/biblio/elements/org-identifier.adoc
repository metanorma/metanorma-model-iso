...
// TODO: salvage prose for this non-terminal. The anchor `[#org-identifier]`
// above is the canonical stable ID that grammar `## @see <<org-identifier>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-org-identifier[biblio.html#define-org-identifier]
