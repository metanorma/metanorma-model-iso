...
// TODO: salvage prose for this non-terminal. The anchor `[#fetched]`
// above is the canonical stable ID that grammar `## @see <<fetched>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-fetched[biblio.html#define-fetched]
