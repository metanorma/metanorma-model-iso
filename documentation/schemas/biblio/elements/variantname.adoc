...
// TODO: salvage prose for this non-terminal. The anchor `[#variantname]`
// above is the canonical stable ID that grammar `## @see <<variantname>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-variantname[biblio.html#define-variantname]
