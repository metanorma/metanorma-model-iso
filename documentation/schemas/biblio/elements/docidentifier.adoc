...
// TODO: salvage prose for this non-terminal. The anchor `[#docidentifier]`
// above is the canonical stable ID that grammar `## @see <<docidentifier>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-docidentifier[biblio.html#define-docidentifier]
