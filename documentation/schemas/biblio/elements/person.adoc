...
// TODO: salvage prose for this non-terminal. The anchor `[#person]`
// above is the canonical stable ID that grammar `## @see <<person>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-person[biblio.html#define-person]
