...
// TODO: salvage prose for this non-terminal. The anchor `[#draft]`
// above is the canonical stable ID that grammar `## @see <<draft>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-draft[biblio.html#define-draft]
