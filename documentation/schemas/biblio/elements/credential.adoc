...
// TODO: salvage prose for this non-terminal. The anchor `[#credential]`
// above is the canonical stable ID that grammar `## @see <<credential>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-credential[biblio.html#define-credential]
