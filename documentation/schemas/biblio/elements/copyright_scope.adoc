...
// TODO: salvage prose for this non-terminal. The anchor `[#copyright_scope]`
// above is the canonical stable ID that grammar `## @see <<copyright_scope>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-copyright_scope[biblio.html#define-copyright_scope]
