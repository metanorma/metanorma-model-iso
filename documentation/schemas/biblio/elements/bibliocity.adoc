...
// TODO: salvage prose for this non-terminal. The anchor `[#bibliocity]`
// above is the canonical stable ID that grammar `## @see <<bibliocity>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bibliocity[biblio.html#define-bibliocity]
