...
// TODO: salvage prose for this non-terminal. The anchor `[#btitle]`
// above is the canonical stable ID that grammar `## @see <<btitle>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-btitle[biblio.html#define-btitle]
