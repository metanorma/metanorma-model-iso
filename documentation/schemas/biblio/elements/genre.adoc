...
// TODO: salvage prose for this non-terminal. The anchor `[#genre]`
// above is the canonical stable ID that grammar `## @see <<genre>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-genre[biblio.html#define-genre]
