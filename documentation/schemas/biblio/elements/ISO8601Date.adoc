...
// TODO: salvage prose for this non-terminal. The anchor `[#ISO8601Date]`
// above is the canonical stable ID that grammar `## @see <<ISO8601Date>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-ISO8601Date[biblio.html#define-ISO8601Date]
