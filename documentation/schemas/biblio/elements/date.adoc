...
// TODO: salvage prose for this non-terminal. The anchor `[#date]`
// above is the canonical stable ID that grammar `## @see <<date>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-date[biblio.html#define-date]
