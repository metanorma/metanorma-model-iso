...
// TODO: salvage prose for this non-terminal. The anchor `[#version]`
// above is the canonical stable ID that grammar `## @see <<version>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-version[biblio.html#define-version]
