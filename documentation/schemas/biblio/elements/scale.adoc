...
// TODO: salvage prose for this non-terminal. The anchor `[#scale]`
// above is the canonical stable ID that grammar `## @see <<scale>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-scale[biblio.html#define-scale]
