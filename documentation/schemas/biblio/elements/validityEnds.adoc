...
// TODO: salvage prose for this non-terminal. The anchor `[#validityEnds]`
// above is the canonical stable ID that grammar `## @see <<validityEnds>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-validityEnds[biblio.html#define-validityEnds]
