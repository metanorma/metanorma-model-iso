...
// TODO: salvage prose for this non-terminal. The anchor `[#TypedTitleString]`
// above is the canonical stable ID that grammar `## @see <<TypedTitleString>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-TypedTitleString[biblio.html#define-TypedTitleString]
