...
// TODO: salvage prose for this non-terminal. The anchor `[#formatted-initials]`
// above is the canonical stable ID that grammar `## @see <<formatted-initials>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-formatted-initials[biblio.html#define-formatted-initials]
