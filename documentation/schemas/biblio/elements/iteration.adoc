...
// TODO: salvage prose for this non-terminal. The anchor `[#iteration]`
// above is the canonical stable ID that grammar `## @see <<iteration>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-iteration[biblio.html#define-iteration]
