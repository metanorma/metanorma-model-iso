...
// TODO: salvage prose for this non-terminal. The anchor `[#biblionote]`
// above is the canonical stable ID that grammar `## @see <<biblionote>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-biblionote[biblio.html#define-biblionote]
