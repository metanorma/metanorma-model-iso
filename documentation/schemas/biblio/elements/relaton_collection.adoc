...
// TODO: salvage prose for this non-terminal. The anchor `[#relaton_collection]`
// above is the canonical stable ID that grammar `## @see <<relaton_collection>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-relaton_collection[biblio.html#define-relaton_collection]
