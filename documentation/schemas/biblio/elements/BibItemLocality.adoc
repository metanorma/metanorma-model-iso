...
// TODO: salvage prose for this non-terminal. The anchor `[#BibItemLocality]`
// above is the canonical stable ID that grammar `## @see <<BibItemLocality>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-BibItemLocality[biblio.html#define-BibItemLocality]
