...
// TODO: salvage prose for this non-terminal. The anchor `[#city]`
// above is the canonical stable ID that grammar `## @see <<city>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-city[biblio.html#define-city]
