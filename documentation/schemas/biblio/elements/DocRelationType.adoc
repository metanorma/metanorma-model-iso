...
// TODO: salvage prose for this non-terminal. The anchor `[#DocRelationType]`
// above is the canonical stable ID that grammar `## @see <<DocRelationType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-DocRelationType[biblio.html#define-DocRelationType]
