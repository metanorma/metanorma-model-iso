...
// TODO: salvage prose for this non-terminal. The anchor `[#contributor]`
// above is the canonical stable ID that grammar `## @see <<contributor>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-contributor[biblio.html#define-contributor]
