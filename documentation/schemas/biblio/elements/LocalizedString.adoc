...
// TODO: salvage prose for this non-terminal. The anchor `[#LocalizedString]`
// above is the canonical stable ID that grammar `## @see <<LocalizedString>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-LocalizedString[biblio.html#define-LocalizedString]
