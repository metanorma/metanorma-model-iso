...
// TODO: salvage prose for this non-terminal. The anchor `[#LocalityType]`
// above is the canonical stable ID that grammar `## @see <<LocalityType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-LocalityType[biblio.html#define-LocalityType]
