...
// TODO: salvage prose for this non-terminal. The anchor `[#bplace]`
// above is the canonical stable ID that grammar `## @see <<bplace>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bplace[biblio.html#define-bplace]
