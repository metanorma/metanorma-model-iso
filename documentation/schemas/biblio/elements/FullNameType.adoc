...
// TODO: salvage prose for this non-terminal. The anchor `[#FullNameType]`
// above is the canonical stable ID that grammar `## @see <<FullNameType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-FullNameType[biblio.html#define-FullNameType]
