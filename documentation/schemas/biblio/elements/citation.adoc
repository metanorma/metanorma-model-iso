...
// TODO: salvage prose for this non-terminal. The anchor `[#citation]`
// above is the canonical stable ID that grammar `## @see <<citation>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-citation[biblio.html#define-citation]
