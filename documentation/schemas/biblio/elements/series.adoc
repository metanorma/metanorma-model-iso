...
// TODO: salvage prose for this non-terminal. The anchor `[#series]`
// above is the canonical stable ID that grammar `## @see <<series>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-series[biblio.html#define-series]
