...
// TODO: salvage prose for this non-terminal. The anchor `[#affiliationdescription]`
// above is the canonical stable ID that grammar `## @see <<affiliationdescription>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-affiliationdescription[biblio.html#define-affiliationdescription]
