...
// TODO: salvage prose for this non-terminal. The anchor `[#BibItemType]`
// above is the canonical stable ID that grammar `## @see <<BibItemType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-BibItemType[biblio.html#define-BibItemType]
