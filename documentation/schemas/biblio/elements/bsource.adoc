...
// TODO: salvage prose for this non-terminal. The anchor `[#bsource]`
// above is the canonical stable ID that grammar `## @see <<bsource>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bsource[biblio.html#define-bsource]
