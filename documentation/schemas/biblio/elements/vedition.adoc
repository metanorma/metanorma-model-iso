...
// TODO: salvage prose for this non-terminal. The anchor `[#vedition]`
// above is the canonical stable ID that grammar `## @see <<vedition>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-vedition[biblio.html#define-vedition]
