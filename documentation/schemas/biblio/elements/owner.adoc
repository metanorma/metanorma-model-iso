...
// TODO: salvage prose for this non-terminal. The anchor `[#owner]`
// above is the canonical stable ID that grammar `## @see <<owner>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-owner[biblio.html#define-owner]
