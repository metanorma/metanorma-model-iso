...
// TODO: salvage prose for this non-terminal. The anchor `[#bcontent]`
// above is the canonical stable ID that grammar `## @see <<bcontent>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bcontent[biblio.html#define-bcontent]
