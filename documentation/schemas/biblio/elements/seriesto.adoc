...
// TODO: salvage prose for this non-terminal. The anchor `[#seriesto]`
// above is the canonical stable ID that grammar `## @see <<seriesto>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-seriesto[biblio.html#define-seriesto]
