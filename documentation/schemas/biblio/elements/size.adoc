...
// TODO: salvage prose for this non-terminal. The anchor `[#size]`
// above is the canonical stable ID that grammar `## @see <<size>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-size[biblio.html#define-size]
