...
// TODO: salvage prose for this non-terminal. The anchor `[#name_abbreviation]`
// above is the canonical stable ID that grammar `## @see <<name_abbreviation>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-name_abbreviation[biblio.html#define-name_abbreviation]
