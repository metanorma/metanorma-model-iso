...
// TODO: salvage prose for this non-terminal. The anchor `[#referenceFrom]`
// above is the canonical stable ID that grammar `## @see <<referenceFrom>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-referenceFrom[biblio.html#define-referenceFrom]
