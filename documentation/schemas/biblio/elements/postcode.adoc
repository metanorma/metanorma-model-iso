...
// TODO: salvage prose for this non-terminal. The anchor `[#postcode]`
// above is the canonical stable ID that grammar `## @see <<postcode>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-postcode[biblio.html#define-postcode]
