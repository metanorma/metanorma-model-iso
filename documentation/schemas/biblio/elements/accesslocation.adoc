...
// TODO: salvage prose for this non-terminal. The anchor `[#accesslocation]`
// above is the canonical stable ID that grammar `## @see <<accesslocation>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-accesslocation[biblio.html#define-accesslocation]
