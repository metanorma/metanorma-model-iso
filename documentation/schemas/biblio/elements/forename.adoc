...
// TODO: salvage prose for this non-terminal. The anchor `[#forename]`
// above is the canonical stable ID that grammar `## @see <<forename>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-forename[biblio.html#define-forename]
