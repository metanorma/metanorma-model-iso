...
// TODO: salvage prose for this non-terminal. The anchor `[#seriesfrom]`
// above is the canonical stable ID that grammar `## @see <<seriesfrom>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-seriesfrom[biblio.html#define-seriesfrom]
