...
// TODO: salvage prose for this non-terminal. The anchor `[#TypedUri]`
// above is the canonical stable ID that grammar `## @see <<TypedUri>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-TypedUri[biblio.html#define-TypedUri]
