...
// TODO: salvage prose for this non-terminal. The anchor `[#formattedref]`
// above is the canonical stable ID that grammar `## @see <<formattedref>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-formattedref[biblio.html#define-formattedref]
