...
// TODO: salvage prose for this non-terminal. The anchor `[#affiliationname]`
// above is the canonical stable ID that grammar `## @see <<affiliationname>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-affiliationname[biblio.html#define-affiliationname]
