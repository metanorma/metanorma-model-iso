...
// TODO: salvage prose for this non-terminal. The anchor `[#BibliographicDateType]`
// above is the canonical stable ID that grammar `## @see <<BibliographicDateType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-BibliographicDateType[biblio.html#define-BibliographicDateType]
