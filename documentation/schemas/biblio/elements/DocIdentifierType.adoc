...
// TODO: salvage prose for this non-terminal. The anchor `[#DocIdentifierType]`
// above is the canonical stable ID that grammar `## @see <<DocIdentifierType>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-DocIdentifierType[biblio.html#define-DocIdentifierType]
