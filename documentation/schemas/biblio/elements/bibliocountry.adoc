...
// TODO: salvage prose for this non-terminal. The anchor `[#bibliocountry]`
// above is the canonical stable ID that grammar `## @see <<bibliocountry>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bibliocountry[biblio.html#define-bibliocountry]
