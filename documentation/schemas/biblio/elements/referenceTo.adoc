...
// TODO: salvage prose for this non-terminal. The anchor `[#referenceTo]`
// above is the canonical stable ID that grammar `## @see <<referenceTo>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-referenceTo[biblio.html#define-referenceTo]
