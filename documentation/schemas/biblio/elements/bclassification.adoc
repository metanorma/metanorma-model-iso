...
// TODO: salvage prose for this non-terminal. The anchor `[#bclassification]`
// above is the canonical stable ID that grammar `## @see <<bclassification>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bclassification[biblio.html#define-bclassification]
