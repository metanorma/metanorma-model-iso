...
// TODO: salvage prose for this non-terminal. The anchor `[#bkeyword]`
// above is the canonical stable ID that grammar `## @see <<bkeyword>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-bkeyword[biblio.html#define-bkeyword]
