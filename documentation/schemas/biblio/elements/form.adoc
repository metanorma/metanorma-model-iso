...
// TODO: salvage prose for this non-terminal. The anchor `[#form]`
// above is the canonical stable ID that grammar `## @see <<form>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-form[biblio.html#define-form]
