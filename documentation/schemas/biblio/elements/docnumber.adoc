...
// TODO: salvage prose for this non-terminal. The anchor `[#docnumber]`
// above is the canonical stable ID that grammar `## @see <<docnumber>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-docnumber[biblio.html#define-docnumber]
