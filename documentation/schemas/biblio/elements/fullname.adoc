...
// TODO: salvage prose for this non-terminal. The anchor `[#fullname]`
// above is the canonical stable ID that grammar `## @see <<fullname>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-fullname[biblio.html#define-fullname]
