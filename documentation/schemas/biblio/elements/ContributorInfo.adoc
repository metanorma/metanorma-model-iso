...
// TODO: salvage prose for this non-terminal. The anchor `[#ContributorInfo]`
// above is the canonical stable ID that grammar `## @see <<ContributorInfo>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-ContributorInfo[biblio.html#define-ContributorInfo]
