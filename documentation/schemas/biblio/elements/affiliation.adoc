...
// TODO: salvage prose for this non-terminal. The anchor `[#affiliation]`
// above is the canonical stable ID that grammar `## @see <<affiliation>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-affiliation[biblio.html#define-affiliation]
