...
// TODO: salvage prose for this non-terminal. The anchor `[#validityRevision]`
// above is the canonical stable ID that grammar `## @see <<validityRevision>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-validityRevision[biblio.html#define-validityRevision]
