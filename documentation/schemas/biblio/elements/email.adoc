...
// TODO: salvage prose for this non-terminal. The anchor `[#email]`
// above is the canonical stable ID that grammar `## @see <<email>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-email[biblio.html#define-email]
