...
// TODO: salvage prose for this non-terminal. The anchor `[#abbreviation]`
// above is the canonical stable ID that grammar `## @see <<abbreviation>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-abbreviation[biblio.html#define-abbreviation]
