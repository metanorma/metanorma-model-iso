...
// TODO: salvage prose for this non-terminal. The anchor `[#seriespartnumber]`
// above is the canonical stable ID that grammar `## @see <<seriespartnumber>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-seriespartnumber[biblio.html#define-seriespartnumber]
