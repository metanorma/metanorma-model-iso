...
// TODO: salvage prose for this non-terminal. The anchor `[#contact]`
// above is the canonical stable ID that grammar `## @see <<contact>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-contact[biblio.html#define-contact]
