...
// TODO: salvage prose for this non-terminal. The anchor `[#AnyElement]`
// above is the canonical stable ID that grammar `## @see <<AnyElement>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-AnyElement[biblio.html#define-AnyElement]
