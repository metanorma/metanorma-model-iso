...
// TODO: salvage prose for this non-terminal. The anchor `[#seriesorganization]`
// above is the canonical stable ID that grammar `## @see <<seriesorganization>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-seriesorganization[biblio.html#define-seriesorganization]
