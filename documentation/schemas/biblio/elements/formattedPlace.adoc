...
// TODO: salvage prose for this non-terminal. The anchor `[#formattedPlace]`
// above is the canonical stable ID that grammar `## @see <<formattedPlace>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-formattedPlace[biblio.html#define-formattedPlace]
