...
// TODO: salvage prose for this non-terminal. The anchor `[#street]`
// above is the canonical stable ID that grammar `## @see <<street>>`
...
See the corresponding SPA panel: link:../../../../biblio.html#define-street[biblio.html#define-street]
